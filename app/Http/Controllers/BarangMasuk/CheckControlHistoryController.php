...
class CheckControlHistoryController extends Controller
{
    public function index()
    {
        ...
        if(Auth::user()->kode_depo == '337'){ //BOGOR
            $in_history = DB::table('barang_dagang_in_history_update')
                    ...
                    ->Where('barang_dagang_in_history_update.kode_depo', '337')
                    ->get();
            ...
            $in_history = DB::table('barang_dagang_in_history_update')
                    ...
                    ->Where('barang_dagang_in_history_update.status', '1')
                    ->Where('barang_dagang_in_history_update.status_bs', '1')
                    ->Where('barang_dagang_in_history_update.kode_depo', '901')
                    ->get();
            ...
            $in_history = DB::table('barang_dagang_in_history_update')
                    ...
                    ->Where('barang_dagang_in_history_update.status', '1')
                    ->Where('barang_dagang_in_history_update.status_bs', '1')
                    ->Where('barang_dagang_in_history_update.kode_depo', '342')
                    ->get();
        }else{
            $in_history = DB::table('barang_dagang_in_history_update')
                    ->join('perusahaans','barang_dagang_in_history_update.kode_perusahaan','=','perusahaans.kode_perusahaan')
        ...
        return view ('masuk_barang.checker_control_history.index', compact('in_history'));
    }
        ...
        if(Auth::user()->kode_depo == '337'){ //BOGOR
            if($kategori=='')
            {
                ...
                $in_history = DB::table('barang_dagang_in_history_update')
                    ...
                    ->Where('barang_dagang_in_history_update.status_bs', '1')
                    ->Where('barang_dagang_in_history_update.kode_depo', '337')
                    ->Where('barang_dagang_in_history_update.kategori', $kategori)
                    ->get();
            }
    ...
    public function view($doc_id)
    {
        ...
        return view ('masuk_barang.checker_control_history.view', compact('head','detail'));  
    }
}
