...
class BodSettlementSppCekController extends Controller
{
    public function index()
    {
        return view ('bod.master_bod.settlement_spp_vs_cek.index');
    }

    public function getSettlementSppCheque(Request $request)
    {
