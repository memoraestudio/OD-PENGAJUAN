...
class MonitoringVitGallonController extends Controller
{
    public function index()
    {
        ...
        $list = DB::table('import_vit_compas_co')
    		...
    		->whereBetween('import_vit_compas_co.tgl_real', [$date_start,$date_end])
    		->get();

        return view('Pembelian.monitoring_vit_gallon.index', compact('list'));
    }
