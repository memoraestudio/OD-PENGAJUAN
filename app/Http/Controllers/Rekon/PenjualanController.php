...
class PenjualanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //                     ->select('dms_cas_doccashtempin.szDocId','dms_cas_doccashtempin.dtmDoc','dms_cas_doccashtempinitem.szAccountId','dms_fin_account.szName', DB::raw('SUM(dms_cas_doccashtempinitem.decAmount) AS decAmount'),'dms_cas_doccashtempinitem.szDescription')
        //                     ->whereBetween('dms_cas_doccashtempin.dtmDoc', ['',''])

        //                     ->groupBy('dms_cas_doccashtempin.szDocId','dms_cas_doccashtempin.dtmDoc','dms_cas_doccashtempinitem.szAccountId','dms_fin_account.szName','dms_cas_doccashtempinitem.szDescription')
        //                     ->get();

        $kredit_dms = DB::connection('mysql_tua')
                        ->select("SELECT dms_cas_doccashtempin.dtmDoc,dms_cas_doccashtempinitem.szAccountId,dms_fin_account.szName, SUM(dms_cas_doccashtempinitem.decAmount) AS decAmount FROM dms_cas_doccashtempin INNER JOIN dms_cas_doccashtempinitem ON dms_cas_doccashtempin.szDocId = dms_cas_doccashtempinitem.szdocid INNER JOIN dms_fin_account ON dms_cas_doccashtempinitem.szAccountId = dms_fin_account.szId WHERE dms_cas_doccashtempin.dtmDoc BETWEEN '' AND '' AND (dms_fin_account.szName LIKE 'HPT%' OR dms_fin_account.szName LIKE 'HJPT%') GROUP BY dms_cas_doccashtempin.dtmDoc,dms_cas_doccashtempinitem.szAccountId,dms_fin_account.szName");

    	return view('rekon.penjualan_tunai.index', compact('kredit','kredit_dms','perusahaan','perusahaan_bank'));
    }

    public function cari(Request $request)
    {
        $perusahaan = DB::table('perusahaans')->get();
        $depo = DB::table('depos')->get();
        ...
        if(request()->perusahaan_dms == '')
        {
            ...
            //                 ->Where('dms_fin_account.szName','like', '%HPT%')
            //                 // ->orWhere('dms_fin_account.szName','like','%HJPT%')
            //                 ->groupBy('dms_cas_doccashtempin.szDocId','dms_cas_doccashtempin.dtmDoc','dms_cas_doccashtempinitem.szAccountId','dms_fin_account.szName','dms_cas_doccashtempinitem.szDescription')
            //                 ->get();
            ...
            if ($pilihdepo == '')
            {
                ...
                //             ->whereBetween('dms_cas_doccashtempin.dtmDoc', [$start_dms, $end_dms])
                //             //->where('dms_fin_account.szName', 'like', '%HPT%')
                //             ->where('dms_fin_account.szName', 'like', '%HJPT%')
                //             ->groupBy('dms_cas_doccashtempin.szDocId','dms_cas_doccashtempin.dtmDoc','dms_cas_doccashtempinitem.szAccountId','dms_fin_account.szName','dms_cas_doccashtempinitem.szDescription')
                //             ->get();
                ...
                $kredit_dms = DB::connection('mysql_tua')
                            ->select("SELECT dms_cas_doccashtempin.dtmDoc,dms_cas_doccashtempinitem.szAccountId,dms_fin_account.szName, SUM(dms_cas_doccashtempinitem.decAmount) AS decAmount FROM dms_cas_doccashtempin INNER JOIN dms_cas_doccashtempinitem ON dms_cas_doccashtempin.szDocId = dms_cas_doccashtempinitem.szdocid INNER JOIN dms_fin_account ON dms_cas_doccashtempinitem.szAccountId = dms_fin_account.szId WHERE dms_cas_doccashtempin.dtmDoc BETWEEN '$start_dms' AND '$end_dms'AND dms_cas_doccashtempin.szBranchId = '$pilihdepo' AND (dms_fin_account.szName LIKE 'HPT%' OR dms_fin_account.szName LIKE 'HJPT%') GROUP BY dms_cas_doccashtempin.dtmDoc,dms_cas_doccashtempinitem.szAccountId");
            }
        ...
        if (request()->norek == '')
        {
            ...
            $kredit = MutasiRekening::whereBetween('tanggal_rek', [$start_bank, $end_bank])
                                    ->where('norek', request()->norek)->get();
        }

        return view('rekon.penjualan_tunai.index', compact('kredit_dms','kredit','perusahaan','depo','rekening'));
