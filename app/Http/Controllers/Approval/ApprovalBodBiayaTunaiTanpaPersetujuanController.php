...
class ApprovalBodBiayaTunaiTanpaPersetujuanController extends Controller
{
    public function index()
    {
    	...
    	$approval = DB::table('pengajuan_biaya')
                                            ...
                                            ->get();
    	return view ('approval.approval_bod_biaya_tanpa_persetujuan.index', compact('approval'));
    }
    ...
    public function view($no_urut)
    {
        ...
        //                         ->get()->sum('tharga');
            ...
            return view('approval.approval_bod_biaya_tanpa_persetujuan.view', compact('approval_cost_head','approval_cost_detail','approval_cost_upload','approval_cost_total'));
    }
