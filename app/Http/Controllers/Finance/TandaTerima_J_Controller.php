...
class TandaTerima_J_Controller extends Controller
{
    public function index()
    {
    	$receipt = DB::table('tanda_terima_cek')->join('users','tanda_terima_cek.id_user_input','=','users.id')
                                                ->Where('tanda_terima_cek.keterangan_id','like','D%')
                                                ->orderBy('tanda_terima_cek.receipt_id', 'ASC')
                                                ->get();

    	return view('finance.tanda_terima_cek_giro_j.index', compact('receipt'));
    }
    ...
    public function view($receipt_id)
    {
        ...
        return view('finance.tanda_terima_cek_giro_j.view',compact('tanda_terima_head','tanda_terima_detail','total_jml','count'));
    }
    ...
    public function create(Request $request)
    {
        ...
        if ($rowCountCode > 0) {
            $keterangan_id = "D-".''.($rowCountCode + 1);
        }else{
            $keterangan_id = "D-1";
        }
    	...
    	return view('finance.tanda_terima_cek_giro_j.create', compact('cek_giro','receipt','keterangan_id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('tanda_terima_j.index');
    }
    ...
    public function pdf($receipt_id)
    {
        ...
        $pdf = PDF::loadview('finance.tanda_terima_cek_giro_j.pdf', compact('tanda_terima_head','tanda_terima_detail','total_jml','count'))->setPaper('a4', 'landscape');
        return $pdf->stream();
    }
