...
class TandaTerima_D_Controller extends Controller
{
    public function index()
    {
    	...
    	return view('finance.tanda_terima_cek_giro_d.index', compact('receipt'));
    }
    ...
    public function view($receipt_id)
    {
        ...
        return view('finance.tanda_terima_cek_giro_d.view',compact('tanda_terima_head','tanda_terima_detail','total_jml','count'));
    }
    ...
    public function create(Request $request)
    {
    	...
    	return view('finance.tanda_terima_cek_giro_d.create', compact('cek_giro','receipt','keterangan_id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('tanda_terima_d.index');
    }
    ...
    public function pdf($receipt_id)
    {
        ...
        $pdf = PDF::loadview('finance.tanda_terima_cek_giro_d.pdf', compact('tanda_terima_head','tanda_terima_detail','total_jml','count'))->setPaper('a4', 'landscape');
        return $pdf->stream();
    }
