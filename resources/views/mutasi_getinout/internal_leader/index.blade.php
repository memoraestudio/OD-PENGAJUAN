                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('mutasi_internal_leader/cari.cari') }}" method="get">
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        @forelse ($mutasi as $val)
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a href="{{ route('mutasi_internal_leader.view', $val->kode_mutasi) }}" class="btn btn-primary btn-sm">View</a>
                                                </td>
                                            </tr>
                                            @empty
                                            <tr>
