                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">
                                Mutasi Internal
                                <a href="{{ route('mutasi.create') }}" class="btn btn-warning btn-sm float-right"><b>M u t a s i</b></a>
                            </h4>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            <form action="{{ route('mutasi/cari.cari') }}" method="get">
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        @forelse ($mutasi as $val)
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a href="{{ route('mutasi.view', $val->kode_mutasi) }}" class="btn btn-primary btn-sm">View</a>
                                                </td>
                                            </tr>
                                            @empty
                                            <tr>
