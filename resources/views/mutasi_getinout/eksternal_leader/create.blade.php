...
<script type="text/javascript">
    ...
    $(function(){
        $('#zona_primary_layak').change(function(){
            var zona_primary_eks = $(this).val();
            if(zona_primary_eks){
                $.ajax({
                    type:"GET",
                    url:"/ajax_zona_primary_eks?zona_primary_eks="+zona_primary_eks,
                    dataType:'JSON',
                    success: function(res){
                        if(res){
                            $("#sub_zona_primary_layak").empty();
                            $("#sub_zona_primary_layak").append('<option>cari</option>');
    ...
    $(function(){
        $('#zona_secondary_layak').change(function(){
            var zona_secondary_eks = $(this).val();
            if(zona_secondary_eks){
                $.ajax({
                    type:"GET",
                    url:"/ajax_zona_secondary_eks?zona_secondary_eks="+zona_secondary_eks,
                    dataType:'JSON',
                    success: function(res){
                        if(res){
    ...
    $(function(){
        $('#perusahaan_tujuan_pri').change(function(){
            var perusahaan_id_pri = $(this).val();
            if(perusahaan_id_pri){
                $.ajax({
                    type:"GET",
                    url:"/ajax_perusahaan_primary_eks?perusahaan_id_pri="+perusahaan_id_pri,
                    dataType:'JSON',
                    success: function(res){
                        if(res){
                            $("#depo_tujuan_pri").empty();
                            $("#depo_tujuan_pri").append('<option value="">Pilih</option>');
                            $.each(res,function(nama,kode){
                                $("#depo_tujuan_pri").append('<option value="'+kode+'">'+nama+'</option>');
                            });
                        }else{
                            $("#depo_tujuan_pri").empty();
                        }
    ...
    $(function(){
        $('#perusahaan_tujuan_secondary').change(function(){
            var perusahaan_id_secondary = $(this).val();
            if(perusahaan_id_secondary){
                $.ajax({
                    type:"GET",
                    url:"/ajax_perusahaan_secondary_eks?perusahaan_id_secondary="+perusahaan_id_secondary,
                    dataType:'JSON',
                    success: function(res){
                        if(res){
                            $("#depo_tujuan_secondary").empty();
                            $("#depo_tujuan_secondary").append('<option value="">Pilih</option>');
                            $.each(res,function(nama,kode){
                                $("#depo_tujuan_secondary").append('<option value="'+kode+'">'+nama+'</option>');
                            });
                        }else{
                            $("#depo_tujuan_secondary").empty();
                        }
...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Mutasi Eksternal</li>
    </ol>
    <div class="container-fluid">
        <div class="animated fadeIn">
            <form action="{{ route('mutasi_eksternal_leader.store') }}" method="post" onkeypress="return event.keyCode != 13" onsubmit="return validasi_input(this)" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div id="form-input-primary">
                                    <div id="form-input-primary" class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-2">
                                                Dari Depo (Asal)
                                                <input type="text" name="depo_asal" id="depo_asal" class="form-control" value="{{ $data->nama_depo }}" readonly>
                                            </div>
                                            ...
                                            <div class="col-md-3 mb-2">
                                                ...
                                                <select name="perusahaan_tujuan_pri" id="perusahaan_tujuan_pri" class="form-control">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-2">
                                                Depo Tujuan
                                                <!--<input type="text" name="pabrik" id="pabrik" class="form-control" value=""> -->
                                                <select name="depo_tujuan_pri" id="depo_tujuan_pri" class="form-control">
                                                    <option value="">Pilih</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mb-2">
                                                Keterangan
                                                <input type="text" name="keterangan_primary" id="keterangan_primary" class="form-control" value="" >
                                            </div>
                                    ...
                                    <div id="form-input-secondary" class="card-body">
                                        <div class="row">
                                            <div class="col-md-3 mb-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="bkb" id="bkb"  class="form-control"> <!-- readonly -->
                                                    <span class="input-group-btn" hidden>
                                                        <button type="button" class="btn btn-info btn-secondary" data-toggle="modal" data-target="#myModal_bkb"> <span class="fa fa-search"></span></button>
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 mb-2">
                                                Perusahaan Tujuan
                                                <!--<input type="text" name="pabrik" id="pabrik" class="form-control" value=""> -->
                                                <select name="perusahaan_tujuan_secondary" id="perusahaan_tujuan_secondary" class="form-control">
                                                    <option value="">Pilih</option>
                                                    @foreach ($perusahaan as $row)
                                                        <option value="{{ $row->kode_perusahaan }}" {{ old('kode_perusahaan') == $row->kode_perusahaan ? 'selected':'' }}>{{ $row->nama_perusahaan }}</option>
                                                    @endforeach 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-2">
                                                Depo Tujuan
                                                <!--<input type="text" name="pabrik" id="pabrik" class="form-control" value=""> -->
                                                <select name="depo_tujuan_secondary" id="depo_tujuan_secondary" class="form-control">
                                                    <option value="">Pilih</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mb-2" hidden>
                                                Kode Sopir
                                                <input type="text" name="id_sopir_secondary" id="id_sopir_secondary" class="form-control" readonly> 
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mb-2">
                                                Keterangan
                                                <input type="text" name="keterangan_secondary" id="keterangan_secondary" class="form-control" value="" >
                                            </div>
