                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">
                                Mutasi Eksternal
                                <a href="{{ route('mutasi_eksternal_leader.create') }}" class="btn btn-primary btn-sm float-right">Mutasi</a>
                            </h4>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            <form action="{{ route('mutasi_eksternal_leader/cari.cari') }}" method="get">
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        @forelse ($data as $val)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($val->status == '0')
                                                        <label class="badge badge-secondary">Dikirim</label>
                                                    @elseif($val->status == '1')
                                                ...
                                                <td align="center">
                                                    <a href="{{ route('mutasi_eksternal_leader.view', $val->kode_mutasi_eks) }}" class="btn btn-success btn-sm">View</a>
                                                </td>
                                            </tr>
                                            @empty
                                            <tr>
