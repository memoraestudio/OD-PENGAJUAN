...
<main class="main">
    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
            <form action="{{ route('mutasi_eksternal.store') }}" method="post" onkeypress="return event.keyCode != 13" onsubmit="return validasi_input(this)" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div id="form-input-primary">
                                    <div id="form-input-primary" class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-2">
                                                Dari Depo (Asal)
                                                <select name="depo_asal" id="depo_asal" class="form-control" hidden>
                                            ...
                                            <div class="col-md-3 mb-2">
                                                    Ke Depo (Tujuan) 
                                                    <select name="depo_tujuan" id="depo_tujuan" class="form-control">
                                                        <option value="">Pilih</option>
                                                        @foreach ($depo as $row)
                                                            <option value="{{ $row->kode_depo }}" {{ old('kode_depo') == $row->kode_depo ? 'selected':'' }}>{{ $row->nama_depo }}</option>
                                                        @endforeach 
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mb-2">
                                                <!--Pabrik-->
                                                <input type="text" name="pabrik" id="pabrik" class="form-control" value="" hidden>
                                            </div>
                                ...
                                <div id="form-input-secondary">
                                    <div id="form-input-secondary" class="card-body">
                                        <div class="row">
                                            <div class="col-md-3 mb-2">
                                                ...
                                                <div class="input-group">
                                                    <input name="bkb" id="bkb" type="text" class="form-control" readonly> <!-- readonly -->
                                            ...
                                            <div class="col-md-3 mb-2">
                                                Dari Depo (Asal)
                                                <select name="zona_primary_layak" id="zona_primary_layak" class="form-control" hidden>
                                                    <option value="">Pilih</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mb-2">
                                                No Polisi
                                                <input type="text" name="no_mobil_secondary" id="no_mobil_secondary" class="form-control" readonly> <!-- readonly -->
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-2">
                                                Nama Sopir
                                                <input type="text" name="nama_sopir_secondary" id="nama_sopir_secondary" class="form-control" readonly> <!-- readonly -->
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mb-2">
                                                <!--Toko/Outlet-->
                                                <input type="text" name="toko" id="toko" class="form-control" hidden>
                                            </div>
