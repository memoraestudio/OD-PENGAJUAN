                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('mutasi_eksternal_in_checker/cari.cari') }}" method="get">
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        @forelse ($data as $val)
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a href="{{ route('mutasi_eksternal_in_checker.view', $val->kode_mutasi_eks) }}" class="btn btn-success btn-sm">View</a>
                                                </td>
                                            </tr>
                                            @empty
                                            <tr>
