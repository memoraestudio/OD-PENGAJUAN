...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Daftar Pengajuan SPPD</li>
    </ol>
                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('approval_bod_sppd/cari.cari') }}" method="get">
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">   
                                                    <a href="{{ route('approval_bod_sppd/view.view', $val->kode_pengajuan_sppd)  }}" class="btn btn-primary btn-sm">View</a>    
                                                </td>
                                            </tr>
                                            <?php $i++ ?>
                                            @empty
