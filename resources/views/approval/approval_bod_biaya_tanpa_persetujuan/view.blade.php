...
@section('title')
    <title>View Pengajuan Biaya Tunai Tanpa Persetujuan</title>
@endsection
...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">View Pengajuan Biaya Tunai Tanpa Persetujuan</li>
    </ol>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                <h4 class="card-title">View Pengajuan Biaya Tunai Tanpa Persetujuan</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
