...
<script type="text/javascript">
    ...
    $("#button_form_approved_1").click(function() {
        let no_urut = $("#no_urut").val();
        let kode_divisi = $("#kode_divisi").val();
        let kode_sub_divisi = $("#kode_sub_divisi").val();
        let jenis = $("#jenis").val();
...
@section('title')
    <title>View Approval (Biaya)</title>
@endsection
...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Approval (Biaya)</li>
        <li class="breadcrumb-item active">View Approval (Biaya)</li>
    </ol>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                <h4 class="card-title">View Approval (Biaya)</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                            ...
                            <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                @forelse ($approval_cost_detail as $row)
                                                    ...
                                                    @endif
                                                        ...
                                                        <td align="right" class="tharga" data-harga="{{ $row->tharga }}">
                                                        ...
                                                        @else
                                                            <td align="center" class="ceklist">
                                                                ...
                                                                @elseif(Auth::user()->kode_divisi == '6') <!-- Jika Accounting-->
                                                                    @if(Auth::user()->kode_sub_divisi == '5') <!-- Manager Biaya Acc (bu Yeni) -->
                                                                        ...
                                                                        @elseif($approval_cost_head->status_validasi_acc == '3') <!-- pending -->
                                                                            @if($row->status_detail_acc == '0')
                                                                                <input type="checkbox" name="chk[]{{ $no }}" id="chk[]{{ $no }}" class="chk-approval" data-harga="{{ $row->tharga }}" onkeyup="input_ket( {{ $no }} );" onclick="input_ket( {{ $no }} );" value="1"  />
                                                                            @elseif($row->status_detail_acc == '1')
                                                                                <input type="checkbox" name="chk[]{{ $no }}" id="chk[]{{ $no }}" class="chk-approval" data-harga="{{ $row->tharga }}" onkeyup="input_ket( {{ $no }} );" onclick="input_ket( {{ $no }} );" value="1" checked  />
                                                                    ...
                                                                    @endif
                                                                @elseif(Auth::user()->kode_divisi == '5') <!-- Jika Finance-->
                                                                    @if(Auth::user()->id == '391' || Auth::user()->id == '698')
                                                                        @if($row->status_detail_atasan == '0') <!-- Baru -->
                                                                            <input type="checkbox" name="chk[]{{ $no }}" id="chk[]{{ $no }}" class="chk-approval" data-harga="{{ $row->tharga }}" onkeyup="input_ket( {{ $no }} );" onclick="input_ket( {{ $no }} );" value="0" />
                                                                        @elseif($row->status_detail_atasan == '0') <!-- Approved -->
                                                                            <input type="checkbox" name="chk[]{{ $no }}" id="chk[]{{ $no }}" class="chk-approval" data-harga="{{ $row->tharga }}" onkeyup="input_ket( {{ $no }} );" onclick="input_ket( {{ $no }} );" value="0" />
                                                                        @elseif($row->status_detail_atasan == '1') <!-- Approved -->
                                                                            <input type="checkbox" class="chk" name="chk" id="chk" value="1" checked/> <!--  -->
                                                                        @elseif($row->status_detail_atasan == '2') <!-- Approved -->
                                                                            <input type="hidden" name="chk" id="chk" value="0">
                                                                            <input type="checkbox" class="chk" name="chk" id="chk" value="1" disabled/> <!--  -->
                                                                        @elseif($row->status_detail_atasan == '3') <!-- Approved -->
                                                                            <input type="hidden" name="chk" id="chk" value="0">
                                                                            <input type="checkbox" class="chk" name="chk" id="chk" value="1" disabled/> <!--  -->
                                                                    ...
                                                                    @else
                                                                        @if($approval_cost_head->kategori == '1' || $approval_cost_head->kategori == '2' || $approval_cost_head->kategori == '5')
                                                                            ...
                                                                            @endif
                                                                        @else
                                                                            @if($approval_cost_head->status_biaya_pusat == '0') <!-- Baru -->
                                                                                <input type="checkbox" name="chk[]{{ $no }}" id="chk[]{{ $no }}"  value="1" />
                                                                            @elseif($approval_cost_head->status_biaya_pusat == '1') <!-- Approved -->
                                                                                <input type="checkbox" name="chk[]{{ $no }}" id="chk[]{{ $no }}" class="chk-approval" data-harga="{{ $row->tharga }}" onkeyup="input_ket( {{ $no }} );" onclick="input_ket( {{ $no }} );" value="1"  />
                                                                            @elseif($approval_cost_head->status_biaya_pusat == '2') <!-- denied -->

                                                                            @elseif($approval_cost_head->status_biaya_pusat == '3') <!-- pending -->
                                                                ...
                                                                @elseif(Auth::user()->kode_divisi == '106') <!-- Biaya Depo-->
                                                                        @if($row->status_detail == '0' && $row->status_detail_atasan == '0') <!-- Baru -->
                                                                            <input type="checkbox" name="chk[]{{ $no }}" id="chk[]{{ $no }}" class="chk-approval" data-harga="{{ $row->tharga }}" onkeyup="input_ket( {{ $no }} );" onclick="input_ket( {{ $no }} );" value="0" />
                                                                        @elseif($row->status_detail == '1' && $row->status_detail_atasan == '0') <!-- Approved -->
                                                                            <input type="checkbox" name="chk[]{{ $no }}" id="chk[]{{ $no }}" class="chk-approval" data-harga="{{ $row->tharga }}" onkeyup="input_ket( {{ $no }} );" onclick="input_ket( {{ $no }} );" value="0" />
                                                                        @elseif($row->status_detail == '1' && $row->status_detail_atasan == '1') <!-- Approved -->
                                                                            <input type="checkbox" class="chk" name="chk" id="chk" value="1" checked/> <!--  -->
                                                                        @elseif($row->status_detail == '1' && $row->status_detail_atasan == '2') <!-- Approved -->
                                                                            <input type="hidden" name="chk" id="chk" value="0">
                                                                            <input type="checkbox" class="chk" name="chk" id="chk" value="1" disabled/> <!--  -->
                                                                        @elseif($row->status_detail == '1' && $row->status_detail_atasan == '3') <!-- Approved -->
                                                                            <input type="hidden" name="chk" id="chk" value="0">
                                                                            <input type="checkbox" class="chk" name="chk" id="chk" value="1" disabled/> <!--  -->
                                                                        ...
                                                                        @endif
                                                                @else
                                                                    @if(Auth::user()->kode_depo == '005')
                                                                        @if($row->status_detail == '0' && $row->status_detail_atasan == '0') <!-- Baru -->
                                                                            <!-- <input type="hidden" name="chk" id="chk" value="0">
                                                                            <input type="checkbox" class="chk" name="chk" id="chk" value="0" disabled/> -->
                                                                            <input type="checkbox" name="chk[]{{ $no }}" id="chk[]{{ $no }}" class="chk-approval" data-harga="{{ $row->tharga }}" onkeyup="input_ket( {{ $no }} );" onclick="input_ket( {{ $no }} );" value="0" />
                                                                        @elseif($row->status_detail == '1' && $row->status_detail_atasan == '0') <!-- Approved -->
                                                                            <input type="checkbox" name="chk[]{{ $no }}" id="chk[]{{ $no }}" class="chk-approval" data-harga="{{ $row->tharga }}" onkeyup="input_ket( {{ $no }} );" onclick="input_ket( {{ $no }} );" value="0" />
                                                                        @elseif($row->status_detail == '1' && $row->status_detail_atasan == '1') <!-- Approved -->
                                                                        ...
                                                                        @elseif($row->status_detail == '3') <!-- pending -->
                                                                            ...
                                                                            <input type="checkbox" class="chk" name="chk" id="chk" value="1" disabled/>
                                                                        @endif
                                                                    @elseif(Auth::user()->kode_depo == '006')
                                                                        @if($row->status_detail == '0' && $row->status_detail_atasan == '0') <!-- Baru -->
                                                                            <!-- <input type="hidden" name="chk" id="chk" value="0">
                                                                            <input type="checkbox" class="chk" name="chk" id="chk" value="0" disabled/> -->
                                                                            <input type="checkbox" name="chk[]{{ $no }}" id="chk[]{{ $no }}" class="chk-approval" data-harga="{{ $row->tharga }}" onkeyup="input_ket( {{ $no }} );" onclick="input_ket( {{ $no }} );" value="0" />
                                                                        ...
                                                                        @elseif($row->status_detail == '3') <!-- pending -->
                                                                            ...
                                                                            <input type="checkbox" class="chk" name="chk" id="chk" value="1" disabled/>
                                                                        @endif
                                                                    @elseif(Auth::user()->kode_depo == '008')
                                                                        @if($row->status_detail == '0' && $row->status_detail_atasan == '0') <!-- Baru -->
                                                                            <!-- <input type="hidden" name="chk" id="chk" value="0">
                                                                            <input type="checkbox" class="chk" name="chk" id="chk" value="0" disabled/> -->
                                                                            <input type="checkbox" name="chk[]{{ $no }}" id="chk[]{{ $no }}" class="chk-approval" data-harga="{{ $row->tharga }}" onkeyup="input_ket( {{ $no }} );" onclick="input_ket( {{ $no }} );" value="0" />
                                                                        ...
                                                                        @elseif($row->status_detail == '3') <!-- pending -->
                                                                            ...
                                                                            <input type="checkbox" class="chk" name="chk" id="chk" value="1" disabled/>
                                                                        @endif
                                                                    @elseif(Auth::user()->kode_depo == '002')
                                                                        @if($row->status_detail == '0' && $row->status_detail_atasan == '0') <!-- Baru -->
                                                                            <!-- <input type="hidden" name="chk" id="chk" value="0">
                                                                            <input type="checkbox" class="chk" name="chk" id="chk" value="0" disabled/> -->
                                                                            <input type="checkbox" name="chk[]{{ $no }}" id="chk[]{{ $no }}" class="chk-approval" data-harga="{{ $row->tharga }}" onkeyup="input_ket( {{ $no }} );" onclick="input_ket( {{ $no }} );" value="0" />
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-2 mb-2">
                                        ...
                                        @else
                                            <input type="text" name="total_harga" id="total_harga" class="form-control" value="0" style="text-align:right; font-style:bold;" required readonly>
                                        @endif
                                        <!-- <input type="text" name="total_harga" id="total_harga" class="form-control" value="{{ $approval_cost_head->total }}" style="text-align:right; font-style:bold;" required readonly> -->
                                ...
                                <div class="row">
                                    ...
                                    @elseif(Auth::user()->kode_divisi == '16') <!-- Jika Cost/Biaya-->
                                        ...
                                        @endif
                                    @elseif(Auth::user()->kode_divisi == '10') <!-- Jika claim-->
                                        @if($approval_cost_head->status_claim  == '1') <!-- approved -->
                                            <div class="col-md-1 mb-2">
                                                <button class="btn btn-success btn-sm" disabled>Approved</button>
                                            </div>
                                        ...
                                        @elseif($approval_cost_head->status_claim  == '2') <!--denied -->
                                            <div class="col-md-1 mb-2">
                                                <button class="btn btn-success btn-sm" disabled>Approved</button>
                                            </div>
                                        ...
                                        @elseif($approval_cost_head->status_claim  == '3') <!-- Pending -->
                                            <div class="col-md-1 mb-2">
                                                <!-- <a href="{{ route('approval_cost_update', $approval_cost_head->no_urut) }}" class="btn btn-success btn-sm">Approved</a> -->
                                                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modalTambahPesan_approve">
                                                    Approved
                                        ...
                                        @endif
                                    @elseif(Auth::user()->kode_divisi == '5') <!-- Jika Finance-->
                                        @if(Auth::user()->id == '391' || Auth::user()->id == '698') <!-- jika id BU berliana -->
