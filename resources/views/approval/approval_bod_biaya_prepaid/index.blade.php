...
@section('title')
    <title> Daftar Pengajuan Biaya Prepaid</title>
@endsection
                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">
                                Daftar Pengajuan Biaya Prepaid
                            </h4>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            <form action="{{ route('approval_bod_biaya_prepaid/cari.cari') }}" method="get">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                        ...
                                                        <a href="{{ route('approval_bod_biaya_prepaid.view', $val->no_urut) }}" class="btn btn-primary btn-sm">View</a>
