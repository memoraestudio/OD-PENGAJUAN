                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">
                                Check and Verify
                                <a href="{{ route('get_out.create') }}" class="btn btn-primary btn-sm float-right">Check and Verify</a>
                            </h4>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        @forelse ($out as $val)
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a href="{{ route('get_out.view', $val->doc_id) }}" class="btn btn-primary btn-sm">View</a>
                                                </td>
                                            </tr>
                                            @empty
                                            <tr>
