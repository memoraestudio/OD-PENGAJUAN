                                                        ...
                                                        <table class="table table-bordered table-striped table-sm" id="tabelinput">
                                                            ...
                                                            @forelse ($detail as $val)
                                                                <tr>
                                                                    ...
                                                                    <td align="right">
                                                                        <input type="number" class="form-control" name="qty_layak[]" id="qty_layak_<?php echo $no++ ?>" style="font-size: 13px; text-align: right;" value="{{ number_format($val->qty_layak) }}">
                                                                    </td>
                                                                    <td align="right">
                                                                    ...
                                                                    <td align="right" hidden>
                                                                        <input type="number" class="form-control" name="qty_bs_ekspedisi[]" id="qty_bs_ekspedisi" style="font-size: 13px; text-align: right;" value="0">
                                                                    </td>
                                                                    @endif
