...
@section('title')
    <title>Laporan Pengajuan Peritem</title>
@endsection
...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Pengajuan Peritem</li>
    </ol>
...
<script>
    document.getElementById('btnExportExcel').addEventListener('click', function(e) {
        ...
        window.open(`{{ route('laporan_pengajuan_perbarang/view.view_excel') }}?${params}`, '_blank');
    });
    ...
    $(function() {
        function loadDepo(perusahaan_id, selected_depo = '') {
            if (perusahaan_id) {
                $.ajax({
                    type: "GET",
                    url: "laporan_pengajuan_perbarang/ajax_depo?perusahaan_id=" + perusahaan_id,
                    dataType: 'JSON',
