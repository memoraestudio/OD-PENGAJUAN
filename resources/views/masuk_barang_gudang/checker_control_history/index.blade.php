                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('gudang_in_check_control_history/cari.cari') }}" method="get">
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        @forelse ($in_history as $val)
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a href="{{ route('gudang_in_check_control_history.view', $val->doc_id) }}" class="btn btn-primary btn-sm">View</a>
                                                </td>
                                            </tr>
                                            @empty
                                            <tr>
