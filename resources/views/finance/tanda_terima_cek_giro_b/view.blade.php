...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Permission B</li>
        <li class="breadcrumb-item active">View Permission B</li>
    </ol>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                <h4 class="card-title">Permission B (View)</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-10 mb-2">
                                        ...
                                        <a href="{{ route('tanda_terima_b/pdf.pdf', $tanda_terima_head->receipt_id) }}" target="_blank" class="btn btn-warning btn-sm"><b>P r i n t</b></a>  
