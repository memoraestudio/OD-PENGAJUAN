...
<script type="text/javascript">
    ...
    function tambah() {
        ...
        for (var i = 0; i < 8; i++) { // Ganti 10 dengan jumlah kolom yang Anda miliki
            ...
            if (i === 0) {
                ...
                cell.innerHTML = '<input type="text" name="keterangan[]" id="keterangan_'+x+'" class="form-control" style="font-size: 12px; height: 30px;" value="">';
            } else if (i === 2) {
    ...
    $(document).ready(function(){
        ...
        {
            $.ajax({
                url:'{{ route("tanda_terima_e/action_seri_awal.action_seri_awal") }}',
                method:'GET',
                data:{query:query},
                dataType:'json',
    ...
    $(document).ready(function(){
        ...
        {
            $.ajax({
                url:'{{ route("tanda_terima_e/action_seri_akhir.action_seri_akhir") }}',
                method:'GET',
                data:{query:query},
                dataType:'json',
                success:function(data)
...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Buat Izin G</li>
    </ol>
    <div class="container-fluid">
        <div class="animated fadeIn">
        <form action="{{ route('tanda_terima_g.store') }}" method="post" onkeypress="return event.keyCode != 13" enctype="multipart/form-data"> 
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">Izin G</h4>
                        </div>
                        <div class="card-body">
                        	<div class="row">
                                ...
                                <div class="col-md-2 mb-2">
                                    ...
                                    <select name="penandatangan" id="penandatangan" class="form-control">
                                        ...
                                        <option value="Yustinus Chaspuri">Yustinus Chaspuri</option>
                                        <option value="Andrew A. W. Unsulangi">Andrew A. W. Unsulangi</option>
                                    </select>
                                </div>
                            </div>  
                        </div>
                                    ...
                                    <div>
                                        <table class="table table-bordered table-striped table-sm" id="tabelinput">
                                            ...
                                            <tbody id="table_warkat">
                                                <tr>
                                                    <td>1</td>
                                                    <td><input type="text" name="keterangan[]" id="keterangan_1" class="form-control" style="font-size: 12px; height: 30px;" value=""></td>
                                                    <td class="vndr">
