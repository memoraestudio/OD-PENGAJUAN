...
<body>
    ...
    <table>
        <tr>
            ...
            <td>
                <b>{{ $header->no_izin_g }}</b><br>
                <b>{{ date('d-M-y', strtotime($header->tgl_izin_g)) }}</b>    
            </td> 
        </tr>
        <tr>
            <td colspan="3">
    ...
    <table border='1' style="border-collapse: collapse; border-color: black; width: 100%; font-size: 11px" >
        <thead>
            <tr>
                <th>No</th>
                <th>Keterangan</th>
        ...
        <tfoot>
            ...
            <tr>
                ...
                <td colspan="3" align="center">Yang mengajukan,</td>
                <td colspan="2" align="center">Menyetujui,</td>
            </tr>
            <tr>
                <td colspan="2" align="center">
                    {{ date('d-M-Y', strtotime($header->tgl_izin_g)) }} 
                    <br>
                    <br>
                    <br>
                    <br>
