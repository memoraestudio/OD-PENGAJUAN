              	...
              	<div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">
                                Izin D
                                <a href="{{ route('tanda_terima_d.create') }}" class="btn btn-primary btn-sm float-right">Buat Izin D</a>
                            </h4>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">   
                                                <a href="{{ route('tanda_terima_d.view', $val->receipt_id) }}" class="btn btn-primary btn-sm">View</a> 
