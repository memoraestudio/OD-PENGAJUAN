@section('js')
    <script type="text/javascript">
        ...
        $('#savedatas').on('submit', function(e){
            e.preventDefault();
            $.ajax({
                url: '{{ route("tanda_terima_d-approved") }}',
                type: 'post',
...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Permission D</li>
        <li class="breadcrumb-item active">View Permission D</li>
    </ol>
    <div class="container-fluid">
        <div class="animated fadeIn">
            
                <div class="row">
                    <form action="{{ route('tanda_terima_d-approved') }}" method="post" onkeypress="return event.keyCode != 13" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                <h4 class="card-title">Permission D (View)</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <table class="table table-bordered table-striped table-sm" id="tabelinput">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th rowspan="2" style="vertical-align: middle;">Rp. Cek/giro</th>
                                            ...
                                            <tfoot>
                                                ...
                                                <th colspan="9" style="text-align: left;">total pemakaian cek/giro: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{ $count }}</th>
                                            </tfoot>
                                        </table>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-10 mb-2">
                                        ...
                                        <a href="{{ route('tanda_terima_d/pdf.pdf', $tanda_terima_head->receipt_id) }}" target="_blank" class="btn btn-warning btn-sm"><b>P r i n t</b></a>  
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('tanda_terima_d-approved') }}" method="post">
                                                                @csrf
