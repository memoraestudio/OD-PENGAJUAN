...
<main class="main">
    <ol class="breadcrumb">
        ...
        @else
            ...
            <li class="breadcrumb-item active">Approval Permission G</li>
        @endif
    </ol>
              	...
              	<div class="col-md-12">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('approval_g/cari.cari') }}" method="get">   
                                    ...
                                    <tbody>
                                       @forelse($receipt as $val)
                                        <tr>
                                            ...
                                            <td align="center">   
                                                <a href="{{ route('approval_g.view', $val->receipt_id) }}" class="btn btn-primary btn-sm">View</a> 
