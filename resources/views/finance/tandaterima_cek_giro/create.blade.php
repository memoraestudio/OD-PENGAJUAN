...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        {
            $.ajax({
                url:'{{ route("tanda_terima/action_modal_cek.actionModalCek") }}',
                method:'GET',
                data:{query:query},
                dataType:'json',
                success:function(data)
                {
                    $('#lookup_modal_cek tbody').html(data.table_data);
                }
            })
        }

        $(document).on('keyup', '#search_modal_cek', function(){
            var query = $(this).val();
            fetch_data_cek(query);
        });
    });

    $(document).on('click', '.pilih_modal_cek', function(e){
        document.getElementById('no_modal_cek').value = $(this).attr('data-id_modal_cek')

        $('#myModalCek').modal('hide');
    });
    ...
    function show_my_pdf() {
        ...
        if( retVal == true ) {
               window.open('{{ route("tanda_terima/pdf.pdf", $receipt) }}', '_blank'); 
        }
    }
    ...
    $(document).ready(function() {
        ...
        function fetch_spp_data(query = '') {
            $.ajax({
                url: '{{ route("tanda_terima/action_cekgiro.actionCekgiro") }}',
                method: 'GET',
                data: {
                    query: query
                },
    ...
    $(document).on('click', '.pilih', function(e) {
        ...
        cell2.innerHTML = '<input type="text" name="spp[]" id="spp" value="'+b+'" style="border:none;" disabled/>'//b;
        cell3.innerHTML = '<input type="text" name="keterangan[]" id="keterangan" value="'+c+'" style="border:none;" disabled/>' //c
        cell4.innerHTML = '<input type="text" name="total_tagihan[]" id="total_tagihan" value="'+d+'" style="text-align:right; border:none;" disabled/>' //c
        cell5.innerHTML = '<input type="text" name="total_nominal[]" id="total_nominal" value="'+d+'" style="text-align:right; border:none;" disabled/>'//d;
        cell6.innerHTML = '<input type="text" name="total_perkategori[]" id="total_perkategori" value="" style="text-align:right; border:none;" disabled/>'
        
        cell7.innerHTML = '<div class="input-group"><input id="no_modal_cek" type="text" name="no_modal_cek"  class="form-control" style="font-size: 12px; height: 30px;" value="" readonly required><span class="input-group-btn"><button type="button" class="btn btn-info btn-secondary" name="btn_vendor_1" id="btn_vendor_1" data-toggle="modal" data-target="#myModalCek" value = "1" style="font-size: 12px; height: 30px; width: 30px;"><span class="fa fa-search"></span></button></span></div>'
        
        cell8.innerHTML = '<input type="text" name="tgl_cek[]" id="tgl_cek" value="" style="border:none;" disabled/>'
        cell9.innerHTML = '<input type="text" name="nama_vendor[]" id="nama_vendor" value="'+e+'" style="border:none;" disabled/>'//e;
        cell10.innerHTML = '<input type="text" name="atas_nama[]" id="atas_nama" value="'+f+'" style="border:none;" disabled/>'//f;
        cell11.innerHTML = '<input type="text" name="bank[]" id="bank" value="'+g+'" style="border:none;" disabled/>'//g;
        cell12.innerHTML = '<input type="text" name="norek[]" id="norek" value="'+h+'" style="border:none;" disabled/>'//h;
...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Izin C</li>
        <li class="breadcrumb-item active">Izin C</li>
    </ol>
    <div class="container-fluid">
        <div class="animated fadeIn">
        <form action="{{ route('tanda_terima.store') }}" method="post" enctype="multipart/form-data"> 
            @csrf
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="no_cek" type="hidden" name="no_cek" class="form-control" readonly required>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div style="border:1px white;height:200px;width:100%;overflow-y:scroll;">
                                        <table class="table table-bordered table-striped table-sm" id="tabelinput">
                                            <thead>
                                                <tr>
                                                    <!--
                                                    <th rowspan="2" style="vertical-align: middle;">No</th>
                                                    <th rowspan="2" style="vertical-align: middle;">Expenditure type</th>
                                                    <th rowspan="2" style="vertical-align: middle;">Total</th>
                                                    <th rowspan="2" style="vertical-align: middle;">Check/giro</th>
                                                    <th rowspan="2" style="vertical-align: middle;">Date</th>
                                                    <th colspan="3" style="text-align: center;">Source of funds</th>
                                                    <th colspan="4" style="text-align: center;">For</th>
                                                </tr>
                                                <tr> -->
                                                    <th rowspan="2" style="vertical-align: middle;">No</th>
                                                    <th rowspan="2" style="vertical-align: middle;">No SPP</th>
                                                    <th rowspan="2" style="vertical-align: middle;">Keterangan</th>
                                                    <th rowspan="2" style="vertical-align: middle;">Nominal Tagihan</th>
                                                    <th rowspan="2" style="vertical-align: middle;">Nominal Cek/BG/Slip</th>
                                                    <th rowspan="2" style="vertical-align: middle;">Total Per Kategori</th>
                                                    <th rowspan="2" style="vertical-align: middle;">Nomor Cek/BG/Slip</th>
                                                    <th rowspan="2" style="vertical-align: middle;">Tanggal Cek/BG/Slip</th>
                                                    <th colspan="4" style="text-align: center;">Tujuan Cek/BG</th>
                                                </tr>
                                                <tr align="center">
...
<div class="modal fade bd-example-modal-lg" id="myModalCek" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" >
        <div class="modal-content" style="background: #fff;">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Data List Cek</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="#" method="get">
                    <div class="input-group mb-3 col-md-6 float-right">
                        <input type="text" name="search_modal_cek" id="search_modal_cek" class="form-control" placeholder="Cari Data . . .">
                    </div>
                </form>
                <div style="border:1px white;width:100%;height:470px;overflow-y:scroll;">
                    <table id="lookup_modal_cek" class="table table-bordered table-hover table-striped">
                        <thead>
                            <tr>
                                <th hidden>Kode</th>
                                <th>No Cek</th>
