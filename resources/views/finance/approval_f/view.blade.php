...
@section('title')
    <title>View Approval Permission F</title>
@endsection
...
<main class="main">
    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
                ...
                <div class="row">
                    <form action="{{ route('approval_f-approved') }}" method="post" onkeypress="return event.keyCode != 13" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                <h4 class="card-title">Approval Permission F</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('approval_f-approved') }}" method="post">
                                                                @csrf
                                            ...
                                            <div class="modal fade" id="modalTambahPesan_pending" tabindex="-1" aria-labelledby="modalTambahPesan_pending" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('approval_f-pending', $tanda_terima_head->receipt_id) }}" method="get">
                                                                @csrf
                                                                <div class="form-group">
                                                                    <label for="">keterangan</label>
                                                                    <textarea name="addKeterangan" id="addKeterangan" cols="10" rows="5" class="form-control" required></textarea>
