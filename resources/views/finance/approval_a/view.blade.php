...
@section('title')
    <title>View Approval Permission A</title>
@endsection
...
<main class="main">
    <ol class="breadcrumb">
         @if(Auth::user()->kode_divisi == '14') <!-- Jika user login BOD, kode divisi 14 -->
            ...
            <li class="breadcrumb-item active">View Izin A</li>
        @else
            <li class="breadcrumb-item">Home</li>
            <li class="breadcrumb-item">Finance</li>
            <li class="breadcrumb-item">Approval</li>
            <li class="breadcrumb-item">Approval A</li>
            <li class="breadcrumb-item active">View Approval Permission A</li>
        @endif
    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
                ...
                <div class="row">
                    <form action="{{ route('approval_a-approved') }}" method="post" onkeypress="return event.keyCode != 13" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                <h4 class="card-title">Approval Permission A</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('approval_a-approved') }}" method="post">
                                                                @csrf
                                            ...
                                            <div class="modal fade" id="modalTambahPesan_pending" tabindex="-1" aria-labelledby="modalTambahPesan_pending" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('approval_a-pending', $tanda_terima_head->receipt_id) }}" method="get">
                                                                @csrf
                                                                <div class="form-group">
                                                                    <label for="">keterangan</label>
                                                                    <textarea name="addKeterangan" id="addKeterangan" cols="10" rows="5" class="form-control" required></textarea>
