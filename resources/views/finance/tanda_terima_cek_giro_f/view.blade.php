@section('js')
    <script type="text/javascript">
        ...
        $('#savedatas').on('submit', function(e){
            e.preventDefault();
            $.ajax({
                url: '{{ route("tanda_terima_f-approved") }}',
                type: 'post',
...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Permission F</li>
        <li class="breadcrumb-item active">View Permission F</li>
    </ol>
    <div class="container-fluid">
        <div class="animated fadeIn">
            
                <div class="row">
                    <form action="{{ route('tanda_terima_f-approved') }}" method="post" onkeypress="return event.keyCode != 13" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                <h4 class="card-title">Permission F (View)</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div style="border:1px white;width:100%;">
                                        <table class="table table-bordered table-striped table-sm" id="tabelinput">
                                            ...
                                            <tfoot>
                                                ...
                                                <th colspan="9" style="text-align: left;">total cek/giro: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{ $count }}</th>
                                            </tfoot>
                                        </table>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-10 mb-2">
                                        ...
                                        <a href="{{ route('tanda_terima_f/pdf.pdf', $tanda_terima_head->receipt_id) }}" target="_blank" class="btn btn-warning btn-sm"><b>P r i n t</b></a>  
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('tanda_terima_f-approved') }}" method="post">
                                                                @csrf
