...
<script type="text/javascript">
    ...
    $(document).on('click', '.pilih_sparepart', function (e) {
                        	...
                        	<form action="{{ route('spp.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div id="form-input-sparepart">
                                    <div id="form-input-sparepart" class="row">
                                        ...
                                        <div class="col-md-3 mb-2">
                                            Counter Bill
                                            <input type="text" name="kontra_sparepart" id="kontra_sparepart" class="form-control" value="-" required readonly>
                                        </div> 
                                    </div>   
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 mb-2">
                                        Request By
                                        <input type="text" name="request_by" id="request_by" class="form-control" required>
                                    </div>
