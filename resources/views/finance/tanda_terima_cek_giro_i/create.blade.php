...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Izin I</li>
        <li class="breadcrumb-item active">Izin I</li>
    </ol>
    <div class="container-fluid">
        <div class="animated fadeIn">
        <form action="{{ route('tanda_terima_i.store') }}" method="post" enctype="multipart/form-data"> 
            @csrf
            <div class="row">
