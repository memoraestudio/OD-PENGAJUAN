    ...
    var x = 1; 
        ...
        $('#lookup_cekgiro').on('click', 'tbody tr', function(e){
            if($("input[name='radio']:checked").val() == "satu" ) {
                ...
                e.preventDefault();
                $('#id_nocekgiro').val($(this).find('td').html());
                $('#nocekgiro').val($(this).find('td').next().html());
                $('#tglcek').val($(this).find('td').next().next().html());
                $('#myModalcekgiro').modal('hide'); 
            }else if($("input[name='radio']:checked").val() == "tiga" ) {
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div id="form-input-dua" class="field_wrapper_2">
                                    <div id="form-input-dua" class="row">
                                        <div class="col-md-4 mb-2">
                                            Cek/Giro Number
                                            <div class="input-group">
                                                <input id="nocekgiro" name="nocekgiro" type="text" class="form-control" readonly required>
                                                <input id="id_nocekgiro" type="hidden" name="id_nocekgiro" class="form-control" required readonly>
                                                <span class="input-group-btn">
                                                    <button type="button" class="btn btn-info btn-secondary" data-toggle="modal" data-target="#myModalcekgiro"> <span class="fa fa-search"></span></button>
                                                </span>
                                            </div>
                                        ...
                                        <div class="col-md-4 mb-2">
                                            Total Cek/Giro
                                            <input type="text" style="text-align: right;" id="nominalcek" name="nominalcek" class="form-control" value="" required readonly>
                                        </div>
                                        <div class="col-md-3 mb-2">
                                            Cek/Giro Date
                                            <input type="date" id="tglcek" name="tglcek" class="form-control" value="" required readonly>
                                        </div>
                                        <div class="col-md-1 mb-2" align="right">
                                            <br>
                                            <a class="btn btn-warning" href="javascript:void(0);" id="add_button_2" title="Add field">+</a>                                        
                                ...
                                <div id="form-input-tiga" class="field_wrapper_2">
                                    <div id="form-input-tiga" class="row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            Total Cek/Giro
                                            <input type="text" style="text-align: right;" id="nominalcek_1" name="nominalcek[]" class="form-control" value="" required >
                                        </div>
                                        <div class="col-md-3 mb-2">
                                            Cek/Giro Date
                                            <input type="date" id="tglcek_1" name="tglcek[]" class="form-control" value="" required readonly>
