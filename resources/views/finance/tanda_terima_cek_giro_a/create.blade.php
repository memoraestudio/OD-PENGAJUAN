...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        {
            $.ajax({
                url:'{{ route("tanda_terima_a/action_cek.actionCek") }}',
                method:'GET',
                data:{query:query},
                dataType:'json',
    ...
    $(document).on('click', '.pilih_cek', function(e){
        ...
        document.getElementById('rekening_pembayar').value = $(this).attr('data-an')
        ...
        document.getElementById('rekening_tujuan').value = $(this).attr('data-kode_vendor')
        document.getElementById('nama_bank_vendor').value = $(this).attr('data-nama_bank_vendor')
        document.getElementById('kode_bank_vendor').value = $(this).attr('data-kode_bank_vendor')
        document.getElementById('no_rek_vendor').value = $(this).attr('data-no_rek_vendor')
    ...
    $(document).ready(function() {
        ...
        function fetch_spp_data(query = '') {
            $.ajax({
                url: '{{ route("tanda_terima_a/action_cekgiro.actionCekgiro") }}',
                method: 'GET',
                data: {
                    query: query
                },
    ...
    $(document).on('click', '.pilih', function(e) {
        ...
        cell2.innerHTML = '<input type="text" name="spp[]" id="spp" value="'+b+'" style="border:none;"/>'//b;
        cell3.innerHTML = '<input type="text" name="keterangan[]" id="keterangan" value="'+c+'" style="text-align:right; border:none;"/>' //c
        cell4.innerHTML = '<input type="text" name="total_tagihan[]" id="total_tagihan" value="'+d+'" style="text-align:right; border:none;"/>' //c
        cell5.innerHTML = '<input type="text" name="total_nominal[]" id="total_nominal" value="'+d+'" style="text-align:right; border:none;"/>'//d;
        cell6.innerHTML = '<input type="text" name="nama_vendor[]" id="nama_vendor" value="'+e+'" style="border:none;"/>'//e;
        cell7.innerHTML = '<input type="text" name="atas_nama[]" id="atas_nama" value="'+f+'" style="border:none;"/>'//f;
        cell8.innerHTML = '<input type="text" name="bank[]" id="bank" value="'+g+'" style="border:none;"/>'//g;
        cell9.innerHTML = '<input type="text" name="norek[]" id="norek" value="'+h+'" style="border:none;"/>'//h;
    ...
    $('#savedatas').on('submit', function(e){
        e.preventDefault();
        $.ajax({
            url: '{{ route("tanda_terima_a.store") }}',
            type: 'POST',
    ...
    function show_my_pdf() {
        ...
        if( retVal == true ) {
               window.open('{{ route("tanda_terima_a/pdf.pdf", $receipt) }}', '_blank'); 
        }
    }
...
@section('title')
	<title>Create Permission A</title>
@endsection
...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Izin A</li>
        <li class="breadcrumb-item active">Izin A</li>
    </ol>
    <div class="container-fluid">
        <div class="animated fadeIn">
        <form action="{{ route('tanda_terima_a.store') }}" method="post" enctype="multipart/form-data"> 
            @csrf
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">Izin A</h4>
                        </div>
                        <div class="card-body">
                        	<div class="row">
                               <div class="col-md-2 mb-2">
                                   No Izin
                                   <input type="text" name="no_izin" id="no_izin" class="form-control" style="text-align: right;" required>
                               </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="text" name="rekening_pembayar" id="rekening_pembayar" class="form-control" style="text-align: right;" value="" required readonly>
                                </div>
                               
                                <div class="col-md-4 mb-2">
                                    Nama Rekening Tujuan
                                    <input type="text" name="rekening_tujuan" id="rekening_tujuan" class="form-control" style="text-align: right;" value="" required readonly>
                                </div>
                            ...
                            <div class="row">   
                                ...
                                <div class="col-md-4 mb-2">
                                    Bank Tujuan
                                    <input type="text" name="nama_bank_vendor" id="nama_bank_vendor" class="form-control" style="text-align: right;" value="" required readonly>
                                    <input type="hidden" name="kode_bank_vendor" id="kode_bank_vendor" class="form-control" style="text-align: right;" value="" required readonly>
                                </div>

                                <div class="col-md-3 mb-2">
                                    No Cek
                                    <div class="input-group">
                                        <input id="no_cek" type="text" name="no_cek" class="form-control" value="" readonly required>
                                        {{-- <input id="cek" type="text" name="cek" class="form-control" readonly required> --}}
                                        <span class="input-group-btn">
                                            <button type="button" class="btn btn-info btn-secondary"
                                                data-toggle="modal" data-target="#myModalRekeningPembayar"> <span
                            ...
                            <div class="row">   
                                ...
                                <div class="col-md-4 mb-2">
                                    No. Rek. Tujuan
                                    <input type="text" name="no_rek_vendor" id="no_rek_vendor" class="form-control" style="text-align: right;" value="" required readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        <table class="table table-bordered table-striped table-sm" id="tabelinput">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th rowspan="2" style="vertical-align: middle;">Nominal Upload</th>
                                                    <th colspan="4" style="text-align: center;">Tujuan Transfer</th>
                                                </tr>
                                                <tr align="center">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-2">
                                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal">Pilih SPP</button>
                                        <button type="button" class="btn btn-danger btn-sm" onclick="return hapusbaris('tabelinput')">Hapus SPP</button>
                                    </div>  
