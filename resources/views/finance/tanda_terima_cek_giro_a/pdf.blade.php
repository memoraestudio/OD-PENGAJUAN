    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="heading">
                ...
                <td rowspan="2" style="vertical-align: middle;">Nominal Tagihan</td>
                <td rowspan="2" style="vertical-align: middle;">Nominal Cek</td>
                <td rowspan="2" style="vertical-align: middle;">Cek/giro</td>
            ...
            <tr class="detail">
                ...
                <td align="right">{{ number_format($row->total_cek) }}</td>
                <td>{{ $row->cek_giro }}</td>
                <td>{{ $row->tanggal }}</td>
