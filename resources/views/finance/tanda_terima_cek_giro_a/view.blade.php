@section('js')
    <script type="text/javascript">
        ...
        $('#savedatas').on('submit', function(e){
            e.preventDefault();
            $.ajax({
                url: '{{ route("tanda_terima_a-approved") }}',
                type: 'post',
...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">View Permission A</li>
    </ol>
    <div class="container-fluid">
        <div class="animated fadeIn">
            
                <div class="row">
                    <form action="{{ route('tanda_terima_a-approved') }}" method="post" onkeypress="return event.keyCode != 13" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                <h4 class="card-title">Permission A (View)</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <table class="table table-bordered table-striped table-sm" id="tabelinput">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th rowspan="2" style="vertical-align: middle;">Nominal Cek</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <input type="text" class="form-control" name="total_cek[]" id="total_cek" style="font-size: 13px;" value="{{ number_format($row->total_cek) }}" readonly hidden>
                                                        {{ number_format($row->total_cek) }}
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td hidden>
                                                        <input type="text" class="form-control" name="no_spp[]" id="no_spp" style="font-size: 13px;" value="" readonly hidden>
                                                        
                                                    </td>
                                                    <td hidden>
                                                        <input type="text" class="form-control" name="no_kontrabon[]" id="no_kontrabon" style="font-size: 13px;" value="" readonly hidden>
                                ...
                                <div class="row">
                                    <div class="col-md-10 mb-2">
                                        ...
                                        <a href="{{ route('tanda_terima_a/pdf.pdf', $tanda_terima_head->receipt_id) }}" target="_blank" class="btn btn-warning btn-sm"><b>P r i n t</b></a>  
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('tanda_terima_a-approved') }}" method="post">
                                                                @csrf
