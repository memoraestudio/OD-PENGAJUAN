...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Izin E</li>
        <li class="breadcrumb-item active">Penerimaan Izin E</li>
    </ol>
    <div class="container-fluid">
        <div class="animated fadeIn">
            <form action="{{ route('tanda_terima_e/store_terima.store_terima') }}" method="post" onkeypress="return event.keyCode != 13" enctype="multipart/form-data">
            @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                <h4 class="card-title">Penerimaan Izin E</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-2 mb-2">
                                        Kode Izin E
                                        <input type="text" name="kode_izin_e" id="kode_izin_e" class="form-control" value="{{ $header->kode_izin_e }}" required readonly>
                                    </div>
                                    <div class="col-md-2 mb-2">
                                        Tanggal Kirim
                                        <input type="text" name="tgl_kirim" id="tgl_kirim" class="form-control" value="{{ date('d-M-Y', strtotime($header->tgl_kirim)) }}" required readonly>
                                    </div>
                                    <div class="col-md-1 mb-2">
                                        No.Izin
                                        <input type="text" name="no_izin" id="no_izin" class="form-control" value="{{ $header->no_izin_e }}" required readonly>
                                    </div>
                                    <div class="col-md-2 mb-2">
                                        Judul Izin <!-- Keterangan -->
                                        <textarea name="judul_izin" id="judul_izin" rows="1" class="form-control" required readonly>{{ $header->judul_izin_e }}</textarea>
                                    </div>
                                    <div class="col-md-3 mb-2">
                                        Catatan <!-- Keterangan -->
                                        <input type="text" name="catatan" id="catatan" class="form-control" value="{{ $header->catatan }}" readonly>
                                    </div>
                                    <div class="col-md-2 mb-2">
                                        Penerima
