...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Buat Izin E</li>
    </ol>
    <div class="container-fluid">
        <div class="animated fadeIn">
        <form action="{{ route('tanda_terima_e/ajax/store.store') }}" method="post" onkeypress="return event.keyCode != 13" enctype="multipart/form-data"> 
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">Izin E</h4>
                        </div>
                        <div class="card-body">
                        	<div class="row">
                                <div class="col-md-2 mb-2">
                                    Tanggal Kirim
                                    <!-- <input type="text" name="tgl_kirim" id="tgl_kirim" class="form-control" value="{{ date('d-M-Y', strtotime(Carbon\Carbon::today()->toDateString())) }}" required readonly> -->
                                ...
                                <div class="col-md-2 mb-2">
                                    ...
                                    <select name="penandatangan" id="penandatangan" class="form-control">
                                        ...
                                        <option value="Charles W. Unsulangi">Charles W. Unsulangi</option>
                                        <option value="Jefri Unsulangi">Jefri Unsulangi</option>
                                    </select>
                                </div>
                            </div>  
                        </div>
