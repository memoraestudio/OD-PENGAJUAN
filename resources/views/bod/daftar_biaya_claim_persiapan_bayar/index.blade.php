...
@section('title')
    <title>Persiapan Pembayaran</title>
@endsection
...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Persiapan Bayar</li>
    </ol>
                                    ...
                                    <table id="datatabel" class="table table-bordered table-sm" style="white-space: nowrap; width:100%; margin-bottom: 0;">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Tgl Pengajuan</th>
                                                <th>Kode Pengajuan Claim</th>
                                                <th>Kode Surat</th>
                                                <th>Kode Promo</th>
                                                <th>Nama Promo</th>
                                                <th>total Nominal Program</th>
                                                <th>No Cheque</th>
                                                <th>total Nominal Cheque</th>
                                                <th>Aksi</th>
                                            </tr>
                                        </thead>
                                        <tbody>
