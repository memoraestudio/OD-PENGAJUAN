@section('js')
    ...
    <script type="text/javascript">
        ...
        function tekan_otorisasi(x){
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('otorisasi_claim_tu_b_detail/otorisasi.otorisasi') }}",
                data: {
                    id: id,
                },
                success: function(response) {
                if (response.res == true) {
                    window.location.href = "{{ route('otorisasi_claim_tu_b/view') }}";
                }else{
		...
		function tekan_batal(x){
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('otorisasi_claim_tu_b_detail/batal.batal') }}",
                data: {
                    id: id,
                },
                success: function(response) {
