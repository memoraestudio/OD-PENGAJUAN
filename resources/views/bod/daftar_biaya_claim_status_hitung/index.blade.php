...
@section('title')
    <title>Daftar Status Pengajuan Perhitungan Program</title>
@endsection
...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Perhitungan Program</li>
    </ol>
                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">
                                Daftar Status Pengajuan Perhitungan Program
                            </h4>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
