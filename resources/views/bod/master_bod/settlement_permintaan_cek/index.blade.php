@section('js')
    ...
    <script type="text/javascript">
        ...
        function fetchAllDataCheque() {
            $.ajax({
                type: "GET",
                url: "{{ route('bod_settlement_permintaan_cek/getDataCheque.getDataCheque') }}",
                dataType: "json",
...
@section('title')
    <title>Permintaan Cheque vs Penerimaan Cheque vs Cheque yang dipakai</title>
@endsection
...
@section('content')
    ...
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Permintaan Cheque vs Penerimaan Cheque vs Cheque yang dipakai</li>
        </ol>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                <h4 class="card-title">
                                    Permintaan Cheque vs Penerimaan Cheque vs Cheque yang dipakai
                                </h4>
                            </div>
                            <div class="card-body">
                                @if (session('success'))
