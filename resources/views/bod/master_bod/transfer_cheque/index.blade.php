@section('js')
    ...
    <script type="text/javascript">
        fetchAllDataTransferCheque();

        function fetchAllDataTransferCheque() {
            $.ajax({
                type: "GET",
                url: "{{ route('bod_cheque_transfer/getDataChequeTransfer.getDataChequeTransfer') }}",
                dataType: "json",
...
@section('title')
    <title>Cheque dan Transfer</title>
@endsection
...
@section('content')
    ...
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Cheque dan Transfer</li>
        </ol>
