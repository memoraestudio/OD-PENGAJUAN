...
<script type="text/javascript">
    fetchAllSppTransfer();
    function fetchAllSppTransfer(){
        $.ajax({
        type: "GET",
        url: "{{ route('bod_spp_cheque/getDataSppTransfer.getDataSppTransfer') }}",
        dataType: "json",
...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">SPP - Transfer</li>
    </ol>
