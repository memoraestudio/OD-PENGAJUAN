...
<script type="text/javascript">
    ...
    function fetchAllSppCheque(){
        $.ajax({
        type: "GET",
        url: "{{ route('bod_spp_cheque/getDataSppCheque.getDataSppCheque') }}",
        dataType: "json",
...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">SPP - Cheque</li>
    </ol>
                                ...
                                <table id="datatabel-v1" class="table table-bordered table-sm" style="white-space: nowrap; width:100%; margin-bottom: 0;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Tujuan Vendor</th>
                                            <th>Status Serah Terima Vendor</th>
                                        </tr>
                                    </thead>
                                    <tbody id="tabledata">
