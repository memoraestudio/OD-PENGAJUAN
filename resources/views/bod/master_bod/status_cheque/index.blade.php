...
@section('content')
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-4">
                                        <div class="card status-card border-left-primary h-100"
                                            data-status="serahkan_metro" data-title="Cheque Serahkan ke Metro/HO">
                                            <div class="card-header bg-white border-bottom-0 pb-0">
                                                <h6 class="card-title mb-0">
    ...
    <!-- Modal Detail Cheque -->
    <div class="modal fade" id="modalDetailCheque" tabindex="-1" role="dialog"
        aria-labelledby="modalDetailChequeLabel">
