...
<script type="text/javascript">
    fetchAllSppCheque();
    function fetchAllSppCheque(){
        $.ajax({
        type: "GET",
        url: "{{ route('bod_settlement_spp_cek/getSettlementSppCheque.getSettlementSppCheque') }}",
        dataType: "json",
        success: function(response) {
            ...
            tabledata += `<tr>`;
                ...
                tabledata += `<td align="right">${chq.jumlah}</td>`;
                tabledata += `<td></td>`;
                tabledata += `<td></td>`;
                tabledata += `<td></td>`;
                tabledata += `<td></td>`;
...
@section('title')
    <title>Pengisian Cheque versus SPP</title>
@endsection
...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Pengisian Cheque versus SPP</li>
    </ol>
