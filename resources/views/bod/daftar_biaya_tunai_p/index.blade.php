...
@section('title')
    <title>Status Pengajuan Biaya Tunai (Persetujuan)</title>
@endsection
...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Status Pengajuan Biaya Tunai (Persetujuan)</li>
    </ol>
                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">
                                Status Pengajuan Biaya Tunai (Persetujuan)
                            </h4>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            <form action="{{ route('bod_biaya_tunai_p/cari.cari') }}" method="get">
