...
@section('title')
    <title>Status Pengajuan Biaya Tunai Tanpa Persetujuan</title>
@endsection
...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Status Pengajuan Biaya Tunai Tanpa Persetujuan</li>
    </ol>
                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">
                                Status Pengajuan Biaya Tunai Tanpa Persetujuan
                            </h4>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            <form action="{{ route('bod_biaya_tunai_tp/cari.cari') }}" method="get">
