...
<script type="text/javascript">
    ...
    function fetchAllDataOtorisasi(){
        ...
        $.ajax({
            type: "GET",
            url: "{{ route('otorisasi_claim_ta_b.getData') }}",
            data: {
                value: value
            },
            dataType: "json",
    ...
    {
        let newPageURL = "{{ route('otorisasi_claim_ta_b/view') }}";
                        ...
                        <div class="card-body">
                            ...
                            @endif
                                ...
                                <div class="input-group mb-4 col-md-1 float-right">  
                                    ...
                                    <a href="{{ route('otorisasi_claim_ta_b/view') }}" class="btn btn-success btn-sm ">O t o r i s a s i</a>
