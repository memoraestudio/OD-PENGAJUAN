...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">COA Layer 3</li>
    </ol>
        ...
        <div class="animated fadeIn">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                        	...
                        	<form action="{{ route('coa_3.store') }}" method="post">
                        		@csrf
                                 ...
                                 <div class="form-group">
                                        ...
                                        <p class="text-danger">{{ $errors->first('dua') }}</p>
                                </div>
                ...
                <div class="col-md-8">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">Account Layer 3</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('coa_3.destroy', $val->kode_lv3) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                ...
                <div class="col-md-4" hidden>
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('coa_3.storeData') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
