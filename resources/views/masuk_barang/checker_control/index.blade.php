                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">
                                Check Control Sheet
                                <a href="{{ route('get_in.create') }}" class="btn btn-primary btn-sm float-right" hidden>Check Control Sheet</a>
                            </h4>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            <form action="{{ route('check_control/cari.cari') }}" method="get">
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        @forelse ($in as $val)
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a href="{{ route('check_control.view', $val->doc_id) }}" class="btn btn-primary btn-sm">View</a>
                                                </td>
                                            </tr>
                                            @empty
                                            <tr>
