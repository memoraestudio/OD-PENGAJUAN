...
<script type="text/javascript">
    ...
    function validasi_input(form){
        if ($("input[name='kategori']:checked").val() == "Primary" ) {
            ...
            if (form.zona_secondary_bs.value == ""){
                alert("Zona BS harus diisi, saat ini Zona BS masih kosong dan belum dipilih!");
                form.zona_secondary_bs.focus();
                return (false);
            }  

            if (form.sub_zona_secondary_bs.value == ""){
                alert("Sub Zona BS harus diisi, saat ini Sub Zona BS masih kosong dan belum dipilih!");
                form.sub_zona_secondary_bs.focus();
                return (false);
            }     

            if (form.id_checker_secondary_bs.value == ""){
                alert("Nama Checker BS harus diisi, saat ini Nama Checker BS masih kosong dan belum dipilih!");
                form.id_checker_secondary_bs.focus();
                return (false);
            }    
        }
...
<main class="main">
    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
            <form action="{{ route('get_in.store') }}" method="post"  onsubmit="return validasi_input(this)" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
