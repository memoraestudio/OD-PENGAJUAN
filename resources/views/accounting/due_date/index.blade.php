                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('duedate.duedatecari') }}" method="get">
                                <div class="input-group mb-3 col-md-6">  
                                    ...
                                    <select name="depo" class="form-control" hidden>
                                        ...
                                        @foreach ($depo_dms as $row_de_dms)
                                            <option value="{{ $row_de_dms->kode_depo }}" {{ old('depo_dms') == $row_de_dms->kode_depo ? 'selected':'' }}>{{ $row_de_dms->nama_depo }}</option>
                                        @endforeach 
                                    </select>
                            ...
                            <form action="{{ route('due_date_simpan.store') }}" method="post" onkeypress="return event.keyCode != 13" enctype="multipart/form-data">
                            @csrf
