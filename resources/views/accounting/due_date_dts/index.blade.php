...
@section('title')
    <title>Jatuh Tempo (Daytech)</title>
@endsection
...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Jatuh Tempo (Daytech)</li>
    </ol>
                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('duedate_dts.duedatecari') }}" method="get">
                            ...
                            <form action="{{ route('due_date_dts_simpan.store') }}" method="post" onkeypress="return event.keyCode != 13" enctype="multipart/form-data">
                            @csrf
