...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Non Tunai Kredit</li>
    </ol>
    <div class="container-fluid">
                    ...
                    <div class="card card-accent-primary">
                        <div class="card-header">
                                ...
                                <div class="input-group col-md-8 float-right">  
                                    <input type="text" id="created_at_dms" name="created_at_dms" class="form-control" value="{{ request()->created_at_dms }}">
                                    &nbsp
                                    <select name="perusahaan_dms" id="perusahaan_dms" class="form-control">
                                        <option value="{{ request()->perusahaan_dms }}">{{ request()->perusahaan_dms }}</option>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <div>
                                <!-- <table id="datatabel-v1" class="table table-bordered table-striped table-sm" > -->
                                    <table  id="datatabel-v1" class="table table-bordered table-sm" style="white-space: nowrap; margin-bottom: 0;"> 
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td hidden>{{ $valdms->szBranchId }}</td>
                                                <td>{{ $valdms->szCustomerId }}</td>
                                                <td>{{ $valdms->szName }}</td>
                                                <td>{{ $valdms->szDocId}}</td>
                                                <td>{{ $valdms->szRefDocId }}</td>
                                                <td align="right">{{ number_format($valdms->decAmount) }}</td>
                                                <td>{{ date('d-M-Y', strtotime($valdms->dtmDue)) }}</td>
                                                <td>
                                                    <select name="norek[]" id="norek{{ $urut }}" class="form-control" style="height: 30px; width: 150px; font-size: 12px;">
                                                ...
                                                <td>
                                                    <input type="text" name="transaksi_lawan_d_[]" id="transaksi_lawan_d_{{ $urut }}" style="height: 30px" class="form-control"></input>
                                                </td>

                                                <!--@foreach ($kredit as $valbank)
                                                    @if($valdms->decAmount == $valbank->nilai)
                                                        <td>
                                                            <input type="text" name="transaksi_lawan" id="transaksi_lawan" style="height: 30px" class="form-control" value="{{ $valbank->nilai }}"></input>
                                                        </td>
                                                    @endif
                                                @endforeach -->
                    ...
                    <div class="card card-accent-primary">
                        <div class="card-header">
                                ...
                                <div class="input-group col-md-10 float-right">
                                    ...
                                    <input type="text" id="created_at_bank" name="created_at_bank" class="form-control" value="{{ request()->created_at_bank }}">
                                    &nbsp
                                    <select name="perusahaan_bank" id="perusahaan_bank" class="form-control">
                                        <option value="">Pilih Perusahaan</option>
                                        @foreach ($perusahaan_bank as $row_pe_re)
                                            <option value="{{ $row_pe_re->kode_perusahaan }}" {{ old('perusahaan_bank') == $row_pe_re->kode_perusahaan ? 'selected':'' }}>{{ $row_pe_re->nama_perusahaan }}</option>
                                        @endforeach 
                                    </select>
                                    &nbsp
                            ...
                            <div class="table-responsive">
                                ...
                                <table  id="datatabel-v2" class="table table-bordered table-sm" style="white-space: nowrap; margin-bottom: 0;">     
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td hidden>#</td>
                                            <td>{{ date('d-M-Y', strtotime($val->tanggal_rek)) }}</td>
                                            <td>{{ $val->id }}</td>
                                            ...
                                            <td>{{ $val->norek }}</td>
                                            <td>
                                                <input type="text" name="transaksi_lawan_b_[]" id="transaksi_lawan_b_{{ $no }}" style="height: 30px" class="form-control"></input>
                                            </td>
                                            <td>
        ...
        <div class="animated fadeIn">
            <div class="row">
                ...
                <!-- MODAL Verif Hapus -->
                            <!-- <div class="modal fade" id="modalSimpan" tabindex="-1" aria-labelledby="modalSimpan" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <h4 class="text-center">Apakah anda yakin akan menyimpan transaksi ini?</h4>
                                        </div>
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#created_at_dms').daterangepicker({
        ...
        function getInputValue(){
            ...
            for(var t = 1; t < tabel_dms.rows.length; t++){
                var inputVal = document.getElementById('transaksi_lawan_d_'+t+'').value;
                var input_norek = document.getElementById('norek'+t+'').value;
                if(inputVal != ''){
                    // $('#datatabel-v3 tbody').append('<tr><td>'+tabel_dms.rows[t].cells[1].innerHTML+'</td><td>'+tabel_dms.rows[t].cells[2].innerHTML+'</td><td>'+tabel_dms.rows[t].cells[4].innerHTML+'</td><td>'+tabel_dms.rows[t].cells[5].innerHTML+'</td><td>'+tabel_dms.rows[t].cells[6].innerHTML+'</td><td>'+tabel_dms.rows[t].cells[7].innerHTML+'</td><td>'+tabel_dms.rows[t].cells[8].innerHTML+'</td><td>'+tabel_dms.rows[t].cells[9].innerHTML+'</td><td><input type="text" name="norek[]" id="norek'+t+'" value="'+input_norek+'" style="height: 30px; width: 140px;" class="form-control"></input></td><td><input type="text" name="transaksi_lawan_d_[]" id="transaksi_lawan_d_'+t+'" value="'+inputVal+'" style="height: 30px" class="form-control"></input></td></tr>')                                               

                    $('#datatabel-v3 tbody').append('<tr><td><input type="text" name="tgl[]" id="tgl'+t+'" value="'+tabel_dms.rows[t].cells[1].innerHTML+'" style="height: 30px; width: 140px;" class="form-control" hidden></input>'+tabel_dms.rows[t].cells[1].innerHTML+'</td><td><input type="text" name="no_tran[]" id="no_tran'+t+'" value="'+tabel_dms.rows[t].cells[2].innerHTML+'" style="height: 30px; width: 140px;" class="form-control" hidden></input>'+tabel_dms.rows[t].cells[2].innerHTML+'</td><td><input type="text" name="kode_toko[]" id="kode_toko'+t+'" value="'+tabel_dms.rows[t].cells[4].innerHTML+'" style="height: 30px; width: 140px;" class="form-control" hidden></input>'+tabel_dms.rows[t].cells[4].innerHTML+'</td><td><input type="text" name="nama_toko[]" id="nama_toko'+t+'" value="'+tabel_dms.rows[t].cells[5].innerHTML+'" style="height: 30px; width: 140px;" class="form-control" hidden></input>'+tabel_dms.rows[t].cells[5].innerHTML+'</td><td><input type="text" name="id_cek[]" id="id_cek'+t+'" value="'+tabel_dms.rows[t].cells[7].innerHTML+'" style="height: 30px; width: 140px;" class="form-control" hidden></input>'+tabel_dms.rows[t].cells[7].innerHTML+'</td><td><input type="text" name="nilai[]" id="nilai'+t+'" value="'+tabel_dms.rows[t].cells[8].innerHTML+'" style="height: 30px; width: 140px;" class="form-control" hidden></input>'+tabel_dms.rows[t].cells[8].innerHTML+'</td><td><input type="text" name="jt[]" id="jt'+t+'" value="'+tabel_dms.rows[t].cells[9].innerHTML+'" style="height: 30px; width: 140px;" class="form-control" hidden></input>'+tabel_dms.rows[t].cells[9].innerHTML+'</td><td><input type="text" name="norek_dms[]" id="norek_dms'+t+'" value="'+input_norek+'" style="height: 30px; width: 140px;" class="form-control"></input></td><td><input type="text" name="transaksi_lawan_d_[]" id="transaksi_lawan_d_'+t+'" value="'+inputVal+'" style="height: 30px" class="form-control"></input></td></tr>')

                    var nilai_d = (tabel_dms.rows[t].cells[8].innerHTML);
