...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Penjualan Tunai</li>
    </ol>
    <div class="container-fluid">
        <!-- DMS  -->
        <form action="{{ route('penjualan_tunai.cari') }}" method="get">
                        ...
                        <div class="card-header">
                            ...
                            <div class="input-group col-md-8 float-right">  
                                ...
                                <select name="perusahaan_dms" id="perusahaan_dms" class="form-control">
                                    ...
                                    @foreach ($perusahaan as $row_pe_dms)
                        ...
                        <div class="card-header">
                            ...
                            <div class="input-group col-md-10 float-right">     
                                ...
                                <select name="perusahaan_bank" id="perusahaan_bank" class="form-control">
                                    <option value="">Pilih Perusahaan</option>
                                    @foreach ($perusahaan as $row_pe_bank)
...
@section('js')
    ...
    <script>
        ...
        //         if(null != tabel_dms.rows[t].cells[9].innerHTML){
        //             $('#datatabel-v3 tbody').append('<tr><td>'+tabel_dms.rows[t].cells[1].innerHTML+'</td><td>'+tabel_dms.rows[t].cells[2].innerHTML+'</td><td>'+tabel_dms.rows[t].cells[6].innerHTML+'</td><td>'+tabel_dms.rows[t].cells[7].innerHTML+'</td><td>'+tabel_dms.rows[t].cells[8].innerHTML+'</td><td>'+tabel_dms.rows[t].cells[9].innerHTML+'</td></tr>')
        //         }
        //     }    
            
        //     var tabel_rek = document.getElementById("datatabel-v2");
        //     for(var u = 1; u < tabel_rek.rows.length; u++){
        //         if(null != tabel_rek.rows[u].cells[7].innerHTML){
        //             $('#datatabel-v4 tbody').append('<tr><td>'+tabel_rek.rows[u].cells[1].innerHTML+'</td><td>'+tabel_rek.rows[u].cells[2].innerHTML+'</td><td>'+tabel_rek.rows[u].cells[4].innerHTML+'</td><td>'+tabel_rek.rows[u].cells[5].innerHTML+'</td><td>'+tabel_rek.rows[u].cells[6].innerHTML+'</td><td>'+tabel_rek.rows[u].cells[7].innerHTML+'</td><td>'+tabel_rek.rows[u].cells[8].innerHTML+'</td></tr>')
        //         }
        //     }
        // });
