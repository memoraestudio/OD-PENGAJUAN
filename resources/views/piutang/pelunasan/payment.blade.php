                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('pelunasan/cari_view.cari_view') }}" method="get">
                                ...
                                <div class="table-responsive">
                                    <!-- <table class="table table-hover table-bordered"> -->
                                        ...
                                        <table id="datatabel-v1" class="table table-bordered table-sm" style="white-space: nowrap; width:100%; margin-bottom: 0;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    @elseif(Auth::user()->kode_divisi == '25') <!-- Kasir --> 
                                                        ...
                                                        <td align="center" hidden><input type="checkbox" name="chk{{ $no }}" id="chk{{ $no }}"  value="1" /></td>
                                                    @else
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="3" align="center" bgcolor="#E6E6E6"><b>Total<b></td>
