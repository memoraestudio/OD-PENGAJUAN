                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="depo" name="depo" class="form-control bg-light" value="Metro" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Area</label>
                                            <input type="text" id="area" name="area" class="form-control bg-light" value="TUA" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="jabatan" name="jabatan" class="form-control bg-light" value="Administrator" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
