                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="depo" name="depo" class="form-control bg-light" value="{{ $data_users->nama_depo }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Area</label>
                                            <input type="text" id="area" name="area" class="form-control bg-light" value="{{ $data_users->area_name }}" readonly>
                                        </div>
                                    </div>
                                </div>
