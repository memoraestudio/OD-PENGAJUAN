                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">Update User Registration</h4>
                        </div>
                        <div class="card-body">

                        	<form action="{{ route('user_registration/edit.edit') }}" method="post" enctype="multipart/form-data">
                        		@csrf
                                <div class="row">
                                ...
                                @if(Auth::user()->kode_divisi == '23') <!-- Jika korsis-->
                                    <div class="row">
										...
										<div class="col-md-3 mb-2" hidden>
                                            Id
                                            <input type="text" name="kode" id="kode" class="form-control" value="{{ $data_pengguna->id }}" required>
                                        </div>
                                        <div class="col-md-3 mb-2">
                                            Nama
                                            <input type="text" name="name" id="name" value="{{ $data_pengguna->name }}" class="form-control" required>
                                        </div>
										
										<div class="col-md-3 mb-2">
                                            Hak Akses
                                            <select name="akses" id="akses" class="form-control">
                                                <option value="{{ $data_pengguna->type }}">{{ $data_pengguna->type }}</option>
                                ...
                                @else
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            Nama Lengkap
                                            <input type="text" name="name" id="name" value="{{ $data_pengguna->name }}" class="form-control" >
                                        </div>
                                        <div class="col-md-3 mb-2" hidden>
                                            Email
                                            <input type="text" name="email" id="email" class="form-control">
                                        ...
                                        <div class="col-md-3 mb-2" hidden>
                                            Nama Pengguna
                                            <div class="input-group">
                                                <input id="nama_lengkap" type="text" name="nama_lengkap" value="{{ $data_pengguna->nama_checker }}" class="form-control" readonly>
                                                <input id="id_employee" type="hidden" name="id_employee" value="{{ $data_pengguna->id_employee }}" readonly>
                                                <span class="input-group-btn">
                                                    <button type="button" class="btn btn-info btn-secondary" data-toggle="modal" data-target="#myModalEmployee"> <span class="fa fa-search"></span></button>
                                                </span>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        Username
                                        <input type="text" name="username" id="username" value="{{ $data_pengguna->username }}" class="form-control" required>
										<input type="hidden" name="username_temp" id="username_temp" value="{{ $data_pengguna->username }}" class="form-control" required>
									</div>
                                    <div class="col-md-3 mb-2" hidden>
                                        Password
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <select name="kode_perusahaan" id="kode_perusahaan" class="form-control">
                                            <option value="{{ $data_pengguna->kode_perusahaan }}">{{ $data_pengguna->nama_perusahaan }}</option>
									...
									@else
										<div class="col-md-3 mb-2">
											Depo
											<select name="kode_depo" id="kode_depo" class="form-control">
												<option value="{{ $data_pengguna->kode_depo }}">{{ $data_pengguna->nama_depo }}</option>
											</select>
										</div>
									@endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-2">
                                            ...
                                            <select name="kode_divisi" id="kode_divisi" class="form-control">
                                                <option value="{{ $data_pengguna->kode_divisi }}">{{ $data_pengguna->nama_divisi }}</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 mb-2">
                                                ...
                                                <select name="status" id="status" class="form-control">
                                                    <option value="{{ $data_pengguna->status_user }}">{{ $data_pengguna->status_user }}</option>
