...
@section('title')
    <title>Jatuh Tempo Pelanggan (Sukanda)</title>
@endsection
...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Daftar Jatuh Tempo (Sukanda)</li>
    </ol>
                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
								<form action="{{ route('list_due_date_sukanda.listcari') }}" method="get">
								...
								<form action="{{ route('list_due_date_sukanda.view') }}" method="post" enctype="multipart/form-data">
								@csrf
