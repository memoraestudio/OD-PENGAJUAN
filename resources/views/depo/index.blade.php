            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                        	...
                        	<form action="{{ route('depo.store') }}" method="post" enctype="multipart/form-data">
                        		@csrf
                ...
                <div class="col-md-8">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                            <form action="{{ route('depo.cari') }}" method="get">
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('depo.destroy', $val->kode_depo) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
