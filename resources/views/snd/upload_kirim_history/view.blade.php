...
@section('title')
    <title>History Upload dan Kirim Surat Program</title>
@endsection
...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">History Promo</li>
        <li class="breadcrumb-item active">History View Upload dan Kirim Surat Program</li>
    </ol>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                    <h4 class="card-title">History Upload dan Kirim Surat Program</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                            ...
                                            @elseif(Auth::user()->kode_sub_divisi == '14') {{--Jika KPJ--}}
                                                ...
                                                @elseif(Auth::user()->kode_perusahaan == 'TUA') {{--Jika SPV--}}
                                                    <td>
                                                        ...
                                                        <br>
                                                        <strong>Lampiran/Attachment Program</strong>
                                                        <div class="table-responsive">
                                                            <table id="datatabel-v1" class="table table-bordered table-sm" style="white-space: nowrap; width:100%; margin-bottom: 0;">
                                                                <tbody>
                                                                    <?php $no=1 ?>
