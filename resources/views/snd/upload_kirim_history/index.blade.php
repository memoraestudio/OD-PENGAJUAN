...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">History Promo</li>
    </ol>
                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('upload_kirim_surat_history/cari.cari') }}" method="get">
                                        ...
                                        <tbody>
                                            ...
                                            @forelse($data_claim as $val)
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('upload_kirim_surat_history.view', $val->no_urut) }}" class="btn btn-primary btn-sm">View Detail Surat</a>
                                                </td>
