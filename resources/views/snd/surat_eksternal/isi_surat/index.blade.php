...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Buat Surat Program</li>
    </ol>
                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">
                                Surat Program
                                <a href="#" class="btn btn-primary btn-sm float-right">Buat Surat</a>
                            </h4>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                                    ...
                                    <table class="table table-bordered table-sm" style="white-space: nowrap; width:100%; margin-bottom: 0;">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td colspan="3" align="center" bgcolor="#E6E6E6"><b>Rp. 0<b></td>
                                            </tr>
                                        </tfoot>
                                    </table>
