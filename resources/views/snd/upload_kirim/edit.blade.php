...
@section('title')
    <title>Edit Surat Program</title>
@endsection
...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Edit Surat Program</li>
    </ol>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                <h4 class="card-title">Edit Surat Program</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <input type="hidden" name="id_user_input" id="id_user_input" class="form-control" value="{{Auth::user()->id}}" required readonly>
                                    </div>

                                    <div class="col-md-3 mb-2" hidden>
                                        Perusahaan
                                        <input type="text" name="kode_perusahaan_user" id="kode_perusahaan_user" class="form-control" value="{{Auth::user()->kode_perusahaan}}" required readonly>
                                    </div>

                                    <div class="col-md-2 mb-2" hidden>
                                        Depo
                                        <input type="text" name="kode_depo_user" id="kode_depo_user" class="form-control" value="{{Auth::user()->kode_depo}}" required readonly>
                                    </div>

                                    <div class="col-md-2 mb-2" hidden>
                                        Divisi
                                        <input type="text" name="kode_divisi_user" id="kode_divisi_user" class="form-control" value="{{Auth::user()->kode_divisi}}" required readonly>
                                    </div>
                                </div>
                                ...
                                <div id="form-input-tiv">
                                    <div class="field_wrapper_tiv">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2 mb-2">
                                                ID Program
                                                <input type="text" name="id_program_tiv" id="id_program_tiv" class="form-control" value="{{ $data_surat->id_program }}">
                                            </div>

                                            <div class="col-md-9 mb-2">
                                                Nama Program
                                                <input type="text" name="nama_program_tiv" id="nama_program_tiv" class="form-control" value="">
                                            </div>

                                            <div class="col-md-1 mb-2">
                                                Jml Peserta
                                                <input type="text" name="jml_peserta" id="jml_peserta" class="form-control" value="">
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="file" class="form-control" name="filename_tiv[]" id="filename_tiv_1" multiple>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="file" class="form-control" name="filename_tiv_lain[]" id="filename_tiv_lain_1" multiple>
                                            </div>                                   
                                        </div>
                                        <br>
                                        <hr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        Nama Program
                                        <input type="text" name="nama_program_distributor" id="nama_program_distributor" class="form-control" value="" required>
                                    </div>
                                    <div class="col-md-2 mb-2">
                                        Periode awal
                                        <input type="date" name="periode_awal" id="periode_awal" class="form-control" value="" required>
                                    </div>
                                    <div class="col-md-2 mb-2">
                                        Periode akhir
                                        <input type="date" name="periode_akhir" id="periode_akhir" class="form-control" value="" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <select name="penerima" id="penerima" class="form-control">
                                            ...
                                            <option value="Tim Distributor dan Tim TIV">Tim Distributor dan Tim TIV</option>
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <select name="sku[]" id="sku[]" class="form-control select2" multiple>
                                            {{-- <option value="">Pilih Segmen</option> --}}
                                            @foreach ($sku as $row)
                                                <option value="{{ $row->sku }}" {{ old('sku') == $row->sku ? 'selected':'' }}>{{ $row->sku }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-2">
                                        Channel/Segmen
                                        <select name="segmen[]" id="segmen[]" class="form-control select2" multiple>
                                            {{-- <option value="">Pilih Segmen</option> --}}
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <button type="button" id="kembali" name="kembali" class="btn btn-primary btn-sm" onclick="goBack()">Kembali</button>

                                            <button type="button" id="batal" name="batal" class="btn btn-warning btn-sm">Batal</button>
                                            
                                            <button type="submit" id="savedatas" name="savedatas" class="btn btn-success btn-sm float-right">Kirim Surat</button>
