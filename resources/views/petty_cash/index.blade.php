                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">
                                Petty Cash
                                <a href="{{ route('petty_cash.create') }}" class="btn btn-primary btn-sm float-right">Tambah Data</a>
                            </h4>
                        </div>
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="{{ route('petty_cash/update.update_view', $val->kode_budget) }}" class="btn btn-warning btn-sm">Edit</a>
                                            </td>
                                        </tr>
                                        <?php $no++ ?>
                                        @empty
