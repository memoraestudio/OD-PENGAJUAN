                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-hover table-striped table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $val->nama_user }}</td>
                                                <td align="center">
                                                    <form action= "{{ route('category.hapus', $val->kode) }}" method="post">        
                                                        @csrf
                            ...
                            {!! $product->links() !!}
                            <a href="{{ route('category.index') }}" class="btn btn-success btn-sm float-right" >K e m b a l i</a>
                            {{-- <button class="btn btn-success btn-sm float-right" onclick="goBack()">K e m b a l i</button> --}}
                        </div>
                    </div>
                </div>
                <!-- ##################################################################################################  -->
