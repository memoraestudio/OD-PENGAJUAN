...
@section('title')
    <title>Jatuh Tempo Pelanggan</title>
@endsection
...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Daftar Jatuh Tempo</li>
    </ol>
                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
								<form action="{{ route('list_due_date.listcari') }}" method="get">
								...
								<form action="{{ route('list_due_date.view') }}" method="post" enctype="multipart/form-data">
								@csrf
