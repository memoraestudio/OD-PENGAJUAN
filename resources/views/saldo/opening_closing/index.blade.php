...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Opening Closing</li>
    </ol>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                <h4 class="card-title">
                                    Opening Closing Rekening Anak TUA Group
                                            ...
                                            <div class="input-group mb-3 col-md-7 float-right">
                                                ...
                                                <select name="jenis" id="jenis" class="form-control">
                                                    ...
                                                    <option value="Tagihan Tunai">Tagihan Tunai</option>
                                                    <option value="Tagihan Kredit">Tagihan Kredit</option>
                                                    <option value="Penjualan Tunai">Rekening Master</option>
                                                </select>
