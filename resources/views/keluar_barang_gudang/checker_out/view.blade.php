...
@section('title')
    <title>Check and Verify (View)</title>
@endsection
...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Check and Verify (View)</li>
    </ol>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                <h4 class="card-title">Check and Verify (View)</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            @elseif($kategori_out->kategori == 'Secondary')
                                            <div class="col-md-3 mb-2" hidden>
                                                Zona BS
                                                <input type="text" name="zona_primary_bs" id="zona_primary_bs" class="form-control" value="" readonly>
                                            </div>
                                            @endif
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-2" hidden>
                                                Sub Zona BS
                                                <input type="text" name="sub_zona_primary_bs" id="sub_zona_primary_bs" class="form-control" value="" readonly>
                                            </div>
                                            @endif
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-2" hidden>
                                                Nama Checker
                                                <input type="text" name="id_checker_primary_bs" id="id_checker_primary_bs" class="form-control" value="" readonly>
                                            </div>
                                            @endif
