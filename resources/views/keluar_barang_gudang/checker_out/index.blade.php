                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">
                                Check and Verify
                                <a href="{{ route('get_out.create') }}" class="btn btn-primary btn-sm float-right" hidden>Check and Verify</a>
                            </h4>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            <form action="{{ route('gudang_out/cari.cari') }}" method="get">
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        @forelse ($out as $val)
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a href="{{ route('gudang_out.view', $val->doc_id) }}" class="btn btn-primary btn-sm">View</a>
                                                </td>
                                            </tr>
                                            @empty
                                            <tr>
        ...
        $(function(){
            $('#kode_perusahaan').change(function(){
                ...
                if(perusahaan_id){
                    $.ajax({
                        type:"GET",
                        url:"/ajax_depo_gudang_out?perusahaan_id="+perusahaan_id,
                        dataType:'JSON',
