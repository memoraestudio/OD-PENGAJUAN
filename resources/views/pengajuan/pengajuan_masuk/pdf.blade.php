    ...
    <div class="invoice-box">
        ...
        <table cellpadding="0" cellspacing="0">    
            ...
            <tr class="detail">
                ...
                <td align="right">{{ number_format($row->qty_pc * $row->price) }}</td>                                    
            </tr>
            {{ $no++ }}
            @empty
            <tr>
                ...
                <tr class="detail">
                    ...
                    <td align="center">
                        @if($pengajuan_head->id_user_approval_it != null)
                            ...
                            <br><br>
                            @if($pengajuan_head->status_it == '1')
                                {{ $pengajuan_head->kode_app_it }}    
                            @elseif($pengajuan_head->status_it == '2')
                    ...
                    <td align="center">
                        @if($pengajuan_head->id_user_approval_ops != null)
                            ...
                            <br><br>
                            @if($pengajuan_head->status_ops == '1')
                                {{ $pengajuan_head->kode_app_ops }}    
                            @elseif($pengajuan_head->status_ops == '2')
                                <span style="color: red;font-size: 12px;">[Denied]</span>
                            @endif 
                            <br><br><br>
                    ...
                    <td align="center">
                        @if($pengajuan_head->id_user_approval_ga != null)
                            ...
                            <br><br>
                            @if($pengajuan_head->status_ga == '1')
                                {{ $pengajuan_head->kode_app_ga }}    
                            @elseif($pengajuan_head->status_ga == '2')
                                <span style="color: red;font-size: 12px;">[Denied]</span>
                            @endif 
                            <br><br><br>
                    ...
                    <td align="center">
                        @if($pengajuan_head->id_user_approval_pc != null)
                            ...
                            @if($pengajuan_head->status_pc == '1')
                                {{ $pengajuan_head->kode_app_pc }}    
                            @elseif($pengajuan_head->status_pc == '2')
                                <span style="color: red;font-size: 12px;">[Denied]</span>
                            @endif 
                            <br><br><br>
