...
<main class="main">
    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
            <form action="{{ route('pengajuan_biaya_upload/upload.upload') }}" method="post" onkeypress="return event.keyCode != 13" enctype="multipart/form-data"> 
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                <h4 class="card-title">View Data Upload</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    @if($approval_cost_head->status_validasi_fin_upload  == '1') <!-- approved -->
                                        <div class="col-md-1 mb-2">
                                            <button type="submit" class="btn btn-success btn-sm" disabled>U p l o a d</button>
                                        </div>
                                        <div class="col-md-1 mb-2">
                                    ...
                                    @else
                                        <div class="col-md-1 mb-2">
                                            <button type="submit" class="btn btn-success btn-sm" id="button_form_upload">U p l o a d</button>
                                        </div>
                                        <div class="col-md-1 mb-2">
