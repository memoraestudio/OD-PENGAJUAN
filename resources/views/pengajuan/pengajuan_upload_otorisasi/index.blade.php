                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('pengajuan_biaya_upload/cari.cari') }}" method="get">
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    @if($val->status_validasi_fin_upload == '0')
                                                        <label class="badge badge-primary">Approved</label>
                                                    @elseif($val->status_validasi_fin_upload == '1')
                                                        <label class="badge badge-success">Done</label>
                                                    @endif
                                                </td>
                                                <td align="center">
                                                    <a href="{{ route('pengajuan_biaya_upload/view.view', $val->no_urut) }}" class="btn btn-primary btn-sm">View</a>
                                                </td>
                                            </tr>
                                            @empty
                                            <tr>
