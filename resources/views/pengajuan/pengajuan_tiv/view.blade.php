                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-primary">
                            <div class="card-header">
                                <h4 class="card-title">Detail Tanggungan TIV - {{ $pengajuan_biaya_head->kode_pengajuan_b }}</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="center" hidden>
                                                                        <button type="button" data-id="{{ $row->description }}" data-perusahaan="{{ $row->spesifikasi }}" data-tgl="{{ $row->tgl_pengajuan_b }}" id="button_view_data" class="btn btn-success btn-sm">View</button>
                                                                    </td>
                                                                </tr>
                                                                @empty
                                                                <tr>
