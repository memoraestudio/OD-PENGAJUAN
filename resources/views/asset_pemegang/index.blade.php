...
<script type="text/javascript">
    ...
    function fetchAllDataAsset(){
        $.ajax({
            type: "GET",
            url: "{{ route('asset_pemegang/getDataPemegang.getDataPemegang') }}",
            dataType: "json",
    ...
    $("#button_form_insert").click(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('asset_pemegang/store.store') }}",
            data: {
...
@section('title')
    <title>List Pemegang Asset</title>
@endsection
...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">List Pemegang Asset</li>
    </ol>
                ...
                <div class="col-md-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">
                            <h4 class="card-title">
                                List Pemegang Asset
                                <button type="button" class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#myModal"><i class="bi bi-plus"></i> Tambah Pemegang</button>
                            </h4>
                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document" >
        <div class="modal-content" style="background: #fff;">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Pemegang</h5>
            ...
            <div class="modal-body">
                <form action="#" method="get">
                    <div class="col-12">
                        <br>
                        <label for="inputNama" class="form-label">Nama Pemegang</label>
                        <input type="text" class="form-control" name="nama_pemegang" id="nama_pemegang" required>
                        <br>
                    </div>
                </form> 
            </div>
